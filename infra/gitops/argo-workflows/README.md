...
kubectl apply -f infra/gitops/argo-workflows/templates/ -n clawql
```
...
Reference pack under [`docs/examples/idp/lending-w2/`](../../../docs/examples/idp/lending-w2/README.md): Docling parse → classify → Argo **suspend** → Label Studio HITL → webhook **resume**. Apply:
...
- [`docs/examples/idp/real-estate/`](../../../docs/examples/idp/real-estate/README.md) — overview
- [`docs/examples/idp/real-estate-title/`](../../../docs/examples/idp/real-estate-title/README.md) — `clawql-realestate-title-ingest`
- [`docs/examples/idp/real-estate-psa/`](../../../docs/examples/idp/real-estate-psa/README.md) — `clawql-realestate-psa-ingest`

```bash
kubectl apply -f docs/examples/idp/real-estate-title/workflow-template.yaml -n clawql
kubectl apply -f docs/examples/idp/real-estate-psa/workflow-template.yaml -n clawql
```
