...
```bash
helm upgrade --install clawql ./manifests/charts/clawql-mcp -n clawql --create-namespace -f your-values.yaml
```
...
kubectl apply -f infra/gitops/argo-workflows/templates/clawql-vault-daily-digest.yaml -n clawql
```
