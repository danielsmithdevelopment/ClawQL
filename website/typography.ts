    ...
    typography: ({ theme }) => ({
      DEFAULT: {
        css: {
          ...
          '--tw-prose-links-hover': '#155e75',
          '--tw-prose-links-underline': 'rgb(14 116 144 / 0.35)',
          ...
          '--tw-prose-invert-links': '#a0e6ff',
          '--tw-prose-invert-links-hover': '#c4f0ff',
          '--tw-prose-invert-links-underline': 'rgb(160 230 255 / 0.35)',
