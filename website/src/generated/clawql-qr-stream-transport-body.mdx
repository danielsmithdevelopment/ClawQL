...
**Depends on:** [`clawql-tee-airgap-audit`](/streams/clawql-tee-airgap-audit) v0.1 · [`clawql-streams`](/streams/clawql-streams) v0.2 · [`mcp-api-adapter`](/mcp/mcp-api-adapter)  
**Related:** [`clawql-tee`](/streams/clawql-tee) · [`clawql-government`](/government/clawql-government) · [`clawql-surveillance`](/surveillance/clawql-surveillance)
...
Frame format extends the [TEE air-gap audit](/streams/clawql-tee-airgap-audit) `AuditFrame` with MCP and election payload types.
...
Use cases: TEE audit export, voting machine ballot streaming, regulated financial export, industrial sensors, government auditor on-site export ([clawql-government](/government/clawql-government)).
...
Seven surfaces connect over a network today (including [`/mcp-ui`](/mcp/mcp-ui)). QR stream connects air-gapped systems to the ClawQL agent surface over a physical channel with per-frame crypto and optional TEE binding.
...
- [`docs/streams/clawql-tee-airgap-audit.md`](/streams/clawql-tee-airgap-audit) — frame crypto shared with TEE audit
- [`docs/streams/clawql-tee.md`](/streams/clawql-tee) — hardware attestation
- [`docs/streams/clawql-streams.md`](/streams/clawql-streams) — event loop / significance
- [`docs/mcp/mcp-api-adapter.md`](/mcp/mcp-api-adapter) — seven surfaces shipped; QR 8th planned
- [`docs/mcp/mcp-ui.md`](/mcp/mcp-ui) — 7th surface (HTMX Swagger UI for MCP, shipped)
- [`docs/government/clawql-government.md`](/government/clawql-government) — auditor air-gap export consumer
