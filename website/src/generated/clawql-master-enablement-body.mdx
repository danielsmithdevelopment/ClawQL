...
_Full design: [Hybrid Decentralized GitHub Alternative](/vision/immutable-releases)._
...
_Full design: [Modularization v2.1](/vision/modularization) · [Token efficiency (8 layers)](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/architecture/clawql-token-efficiency.md)._
...
**Shipped today:** [`clawql-ouroboros`](/ouroboros) — specification-first seeds, evolutionary loop, ontology convergence gates, optional MCP tools when `CLAWQL_ENABLE_OUROBOROS=1`.
...
_Full target design (vision): [DAOS Unified Architecture v2.7](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/ouroboros/daos-unified-architecture-specification-v2.7.md). Coordination deep dive: [Coordination layer spec](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/ouroboros/daos-coordination-layer-specification.md)._
...
_Full design: [Token efficiency (8 layers)](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/architecture/clawql-token-efficiency.md)._
...
_Full design: [Defense-in-Depth Security Guide](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/clawql-defense-in-depth-security-guide.md) · [Security curriculum (32 modules)](/security/best-practices)._
...
_Full design: [Deployment & Operations Guide](/deployment/operations-guide) · [Operator target architecture (planned)](/design/operator-target-architecture) · [Modularization v2.1](/vision/modularization)._
...
_Honest shipped vs planned table: [Vision & Roadmap](/vision/roadmap). Implementation ground truth: [Modularization implementation status](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/design/modularization-implementation-status.md). Contracts: [Contributor Technical Specification](/contributing/technical-specification)._
...
| Document                                                                                                                                                    | Role                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| **[Modularization implementation status](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/design/modularization-implementation-status.md)**  | **Ground truth** — monorepo layout, shims, phases, Effect/plugin status (June 2026)          |
| **[ClawQL plugin model](/reference/plugins)**                                                                                                               | Horizontal plugins — MCP tool registration, lifecycle, third-party path                      |
| **[Plugin registry](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/reference/clawql-plugin-registry.md)**                                  | Shipped vs planned plugins, MCP tools, enable flags                                          |
| [Vision & Roadmap](/vision/roadmap)                                                                                                                         | Public edition — honest shipped vs planned, phased delivery                                  |
| [Modularization v2.1](/vision/modularization)                                                                                                               | Package boundaries, dependency graph, intelligent MCP gateway                                |
| **[IDP Platform (April 2026)](/vision/idp-platform)**                                                                                                       | End-to-end IDP: self-hosted + hosted, archive layer, Coneshare VDR, Merkle audit             |
| [Immutable releases (Layer 0)](/vision/immutable-releases)                                                                                                  | Arweave bundles, Radicle, Rift, `clawql-release`, manifest schema                            |
| [Contributor Technical Specification](/contributing/technical-specification)                                                                                | Implementation contracts, Effect-TS patterns, CI rules                                       |
| [Deployment & Operations Guide](/deployment/operations-guide)                                                                                               | Shipped Helm ops — quick start, day-2, health                                                |
| [Operator scaffold (7.0)](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/deployment/clawql-operator-helm.md)                               | Shipped opt-in CRD + reconcile + tier presets                                                |
| [Operator target architecture](/design/operator-target-architecture)                                                                                        | Full operator roadmap — NL ops, verticals, auth (not shipped)                                |
| [Dashboard Agent Chat](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/dashboard/agent-chat.md)                                             | Browser UI, SSE, vault threads, IDP attachment JSON contract                                 |
| [Defense-in-Depth Security Guide](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/clawql-defense-in-depth-security-guide.md)       | What to deploy — condensed operator reference                                                |
| [Security curriculum](/security/best-practices)                                                                                                             | 32 modules — why and how to prove controls                                                   |
| [Token efficiency (8 layers)](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/architecture/clawql-token-efficiency.md)                      | Code Mode through model routing                                                              |
