...
_Full design: [Deployment & Operations Guide](/deployment/operations-guide) · [Modularization v2.1](/vision/modularization)._
...
**Shipped:** MCP transport (stdio/HTTP/gRPC), Ouroboros library, Layer 0 tooling, LGTMP reference stack, **horizontal package extraction** (`clawql-core`, `clawql-api`, `clawql-memory`, `clawql-documents`, `clawql-automation` scaffolds) — see **[Modularization implementation status](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/design/modularization-implementation-status.md)**.
...
| [Deployment & Operations Guide](/deployment/operations-guide)                                                                                              | Tier 1–3, CRD reference, day-2 ops                                                  |
