...
_Full target design (vision): [DAOS Unified Architecture v2.7](/ouroboros/daos). Coordination deep dive: [Coordination layer spec](/ouroboros/specification)._
...
_Full design: [Defense-in-Depth Security Guide](/security/defense-in-depth) · [Security curriculum (32 modules)](/security/best-practices)._
...
| [Defense-in-Depth Security Guide](/security/defense-in-depth)                                                                                              | What to deploy — condensed operator reference                                                |
...
| [DAOS Unified Architecture v2.7](/ouroboros/daos)                                                                                                          | **Vision / roadmap** — 7-layer platform, Manifest, PEP, Memory 2.0, Circuit Breaker          |
| [Coordination layer spec](/ouroboros/specification)                                                                                                        | **Vision / roadmap** — transport + NSV/SGDOP, Diversity Dividends, Coordinator (not shipped) |
| [DAOS build plan v2.7.1](/ouroboros/build-plan)                                                                                                            | **Vision / roadmap** — P0–P3 engineering contract                                            |
