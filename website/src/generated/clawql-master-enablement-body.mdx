...
_Full design: [Modularization v2.1](/architecture) · [Token efficiency (12 layers)](/architecture/token-efficiency)._
...
_Full design: [Deployment & Operations Guide](/deployment/operations-guide) · [Operator target architecture (planned)](/design/operator-target-architecture) · [Modularization v2.1](/architecture)._
...
| [Modularization v2.1](/architecture)                                                                                                               | Package boundaries, dependency graph, intelligent MCP gateway                                |
