...
_Full design: [DAOS Unified Architecture v2.7](/ouroboros/daos). Coordination deep dive: [Coordination layer spec](/ouroboros/specification)._
...
_Full design: [Deployment & Operations Guide](/deployment/operations-guide) · [Operator target architecture (planned)](../design/operator-target-architecture.md) · [Modularization v2.1](/vision/modularization)._
...
| **[Plugin registry](/reference/plugins#plugin-registry)**                                                                                                  | Shipped vs planned plugins, MCP tools, enable flags                                 |
...
| [DAOS Unified Architecture v2.7](/ouroboros/daos)                                                                                                          | 7-layer platform, Manifest, PEP, Memory 2.0, Circuit Breaker                        |
| [Coordination layer spec](/ouroboros/specification)                                                                                                        | Transport + NSV/SGDOP, Diversity Dividends, Coordinator                             |
| [DAOS build plan v2.7.1](/ouroboros/build-plan)                                                                                                            | P0–P3 engineering contract                                                          |
