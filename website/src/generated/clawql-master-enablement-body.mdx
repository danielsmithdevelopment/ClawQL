...
| **[ClawQL plugin model](/plugins#plugin-model)**                                                                                                            | Horizontal plugins — MCP tool registration, lifecycle, third-party path                      |
| **[Plugin registry](/plugins#registry)**                                                                                                                    | Shipped vs planned plugins, MCP tools, enable flags                                          |
