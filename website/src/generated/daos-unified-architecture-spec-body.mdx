...
**Related:** [Coordination layer](/ouroboros/specification) · [Build plan v2.7.1](/ouroboros/build-plan) · [Ouroboros library](/ouroboros) · [Master enablement guide](/architecture) · [NATS JetStream](/helm)
...
**P2 navigation (design):** Guided, warm-started graph traversal (Lifelong MAPF heuristics) is specified in [`lifelong-guided-traversal.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/lifelong-guided-traversal.md) — distillation as guided exploration and fidelity biased by high-ROI traversed paths.
...
interface WORMEntry {
  ...
  agent_id: string
  source:
    'PEP' | 'WATCHDOG' | 'MEMORY' | 'OUROBOROS' | 'BREAKOUT' | 'COMMAND_DECK'
