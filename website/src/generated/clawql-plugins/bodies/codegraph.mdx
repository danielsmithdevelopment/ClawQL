...
Extension matrix and package layout: [`packages/clawql-codegraph/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-codegraph/README.md).
