...
- **Compose:** [`docker/compose/lending.compose.yml`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docker/compose/lending.compose.yml) and [`docling-classifier.compose.yml`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docker/compose/docling-classifier.compose.yml).
