...
**Read first:** [hosted vs self-hosted compliance](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/hosted-vs-self-hosted-compliance.md). Managed hosting uses Stripe for **platform fees** and optional **closed-loop company credits** ([org-credits](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/org-credits.md)). **Cross-tenant P2P** and **agent compensation** are self-hosted opt-in and forced off when `CLAWQL_MANAGED_HOSTING=1`.
...
Operator guide: [clawql-payments](/payments/clawql-payments) → `/payments/clawql-payments` (includes [Accounting & tax](/payments/clawql-payments#accounting--tax)). **Learn walkthrough:** [Payments & entitlements](https://docs.clawql.com/learn/payments-and-entitlements). Cloudflare prep: [cloudflare-wallets](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/cloudflare-wallets.md).
...
Full ownership model (subledger vs GL, 1099 / W-9, no in-process e-file): [accounting-and-tax.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/accounting-and-tax.md).
...
- [Accounting & tax](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/accounting-and-tax.md)
- [Inference payments integration](/inference/clawql-inference#plan-entitlements-and-payments-clawql-payments)
