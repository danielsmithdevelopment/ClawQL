...
**Decision:** [ADR 0009](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/adr/0009-enterprise-ontology.md) · [Enterprise Ontology](/architecture/enterprise-ontology) · Convergence context: [PragmaticVectors — Convergence Week](https://pragmaticvectors.com/posts/convergence-week/)
...
For **`type: decision`**, prefer the AIF-inspired body sections in [**OKF decision rationale**](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/okf-decision-rationale.md).
...
const issues = lintOkfMarkdown(next, {
  checkStale: true,
  requireWormRef: path.endsWith('.cqk'),
})
```
...
See [PorTAL + Intelligence Flywheel](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/inference/portal-flywheel.md).
...
- Custom extensions (`.cqk`, etc.) are **optional promotions** after OKF — see [ADR 0010](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/adr/0010-cq-file-extensions.md).
...
- [memory-obsidian.md](/learn/memory)
- [okf-decision-rationale.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/okf-decision-rationale.md)
- [mcp-tools.md](/tools) § `memory_ingest`
- [ADR 0010 — `.cq*` extensions](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/adr/0010-cq-file-extensions.md)
- [`.cqk` draft spec](/specs/cq-extensions/cqk)
- [PorTAL flywheel intentions](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/inference/portal-flywheel.md)
