...
>
> **Related:** [Agents index](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/agents/README.md) · [Personal Hermes/Cline setup](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/homelab/personal-agent-hermes-cline.md) · [Agents OpenBench spec](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/agents-openbench-spec-v0.1.md) · [OpenBench plan](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/agents-openbench-plan.md) · [Modularization status](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/design/modularization-implementation-status.md) · [clawql-tee](/streams/clawql-tee) (draft) · [MCP tools](/tools)
...
| npm `@clawql/agents`, `@clawql/core`, `@clawql/audit` | Packages are **unscoped** `clawql-*`. MCP audit ring lives in **`clawql-core`**. Durable WORM ships in **`clawql-audit@8.0.0`**: [`../audit/clawql-audit-spec-v0.1.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/audit/clawql-audit-spec-v0.1.md). |
...
| OpenClaw MCP wiring                                   | Adapter live MCP plans + `scripts/dev/openclaw-register-clawql.sh`; operator docs in [`docs/openclaw/`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/openclaw/using-openclaw-with-clawql.md)                                                           |
...
| clawql-tee attestation                                | **Draft** spec ([`docs/streams/clawql-tee.md`](/streams/clawql-tee)); not a runtime flag you can flip                                                                                                                                                                     |
...
1. Live Agents OpenBench A/B (Harvey LAB + ExtractBench publish — see [plan](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/agents-openbench-plan.md)).
...
The `bench/` directory contains the ClawQL Agents OpenBench harness for each agent. See the [Agents OpenBench specification](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/agents-openbench-spec-v0.1.md) for the full task definitions.
...
`packages/clawql-audit/` ships at **0.1.0** (see [`../audit/clawql-audit-spec-v0.1.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/audit/clawql-audit-spec-v0.1.md)). Agents import `clawql-audit` for durable WORM — not a parallel WORM client. MCP `audit` remains the ephemeral ring.
...
2. **`clawql-audit` first** ([spec](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/audit/clawql-audit-spec-v0.1.md)) — adapters must not invent a second WORM client.
