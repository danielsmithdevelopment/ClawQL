...
See the [personal agent setup](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/hermes/personal-agent-setup.md) document for the full `WORMInstrumentedAgent` subclass implementation.
...
The WORM hooks use Cline's SDK hook system, which exposes pre/post hooks for file operations and terminal execution. The full hook implementation is in the [personal agent setup](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/hermes/personal-agent-setup.md) document.
