...
- **`GET /metrics`** on MCP HTTP — [Grafana dashboard](/learn/audit-tool-and-observability) ([#210](https://github.com/danielsmithdevelopment/ClawQL/issues/210))
...
| IDP eight-vendor stack         | [idp-pipeline.md](/learn/document-pipeline) · [clawql-idp-helm.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/deployment/clawql-idp-helm.md) · [observability/README.md](/docker-desktop-observability) |
