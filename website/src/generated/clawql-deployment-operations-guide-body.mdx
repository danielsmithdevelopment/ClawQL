...
You can also use the dashboard at [localhost:8080](http://localhost:8080) — go to the Documents Pipeline page and use the drag-and-drop uploader.
...
_For platform vision: see the [Vision & Roadmap document](/vision/roadmap)._  
_For contributor contracts: see the [Contributor Technical Specification](/contributing/technical-specification)._
