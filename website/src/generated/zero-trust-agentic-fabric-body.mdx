...
- **Enterprise Ontology** (typed entities, kinetic writes, OKF + Git/R2 split — closes Palantir Ontology gap without lock-in): [enterprise-ontology.md](/architecture/enterprise-ontology) · [ADR 0009](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/adr/0009-enterprise-ontology.md)
