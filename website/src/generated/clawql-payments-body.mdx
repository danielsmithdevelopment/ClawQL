...
**Package:** [`packages/clawql-payments`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-payments)  
**CLI:** `clawql payments *`
...
Defined in [`packages/clawql-payments/src/plans/tiers.ts`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-payments/src/plans/tiers.ts):
...
Implementation: [`packages/clawql-inference/src/entitlements/`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-inference/src/entitlements).
...
Supported handlers: [`packages/clawql-payments/src/stripe/webhook.ts`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-payments/src/stripe/webhook.ts).
...
See [payouts-ramp.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/payouts-ramp.md).
...
See [agent-compensation.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/agent-compensation.md) and [sgdop-coordinator-compensation-bridge.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/payments/sgdop-coordinator-compensation-bridge.md).
...
Middleware mounts **before** auth in [`packages/clawql-inference/src/api/server.ts`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-inference/src/api/server.ts).
...
See also: [`packages/clawql-inference/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-inference/README.md).
