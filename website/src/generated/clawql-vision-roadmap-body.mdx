...
_For planned Operator / CRD deployment: see [Operator target architecture](../design/operator-target-architecture.md). Shipped installs: [Deployment & Operations Guide](/deployment/operations-guide)._
