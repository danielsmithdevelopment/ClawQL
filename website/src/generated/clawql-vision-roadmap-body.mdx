...
**Phase 1 is complete.** Evaluate today with [Tier 1 Docker Compose](https://github.com/danielsmithdevelopment/ClawQL/blob/main/examples/clawql-local-docker-compose/README.md) or Helm; start at [Getting started](https://docs.clawql.com/getting-started).
