...
- [clawql-payments](/payments/clawql-payments) — WORM audit store pattern reused by `SurveillanceWORMAuditService`
- [clawql-inference](/inference/clawql-inference) — Agentic Gateway entry; MCP tool registration surface
- [Plugin registry](/plugins#registry) — planned domain verticals
- [Modularization v2.1](/architecture) — package architecture
