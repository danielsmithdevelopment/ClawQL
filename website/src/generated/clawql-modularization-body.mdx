...
![ClawQL modularization dependency stack: seven layers from ClawQL Core through core services, service plugins, Documents and Sandbox, Automation, industry verticals, to vertical plugins](/vision/clawql-dependency-stack.png)
