...
**Horizontal plugins:** memory, documents, automation, sandbox, and ouroboros **register MCP tools via `Plugin.onRegister`** when composed — see [ClawQL plugin model](/plugins#plugin-model).
