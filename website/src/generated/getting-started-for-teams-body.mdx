...
See [`packer/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packer/README.md) for GCP and CI validate targets. Use a **clawql-mcp** version that includes `clawql gateway` (Managed Edge Gateway).
