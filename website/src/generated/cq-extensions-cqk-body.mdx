...
Prefer the [decision rationale template](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/okf-decision-rationale.md) body sections when `type: decision`. Worked example: [`examples/ontology/okf/decision-rationale-template.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/examples/ontology/okf/decision-rationale-template.md).
