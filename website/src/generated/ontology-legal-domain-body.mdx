...
Client joins, amortized multi-question sessions, and full C&H mount follow the suite plan in [`docs/benchmarks/openbench-b7-calderwood.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/openbench-b7-calderwood.md).
