...
**Status:** Draft v0.1 · [ADR 0010](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/adr/0010-cq-file-extensions.md) · Schema: [`schemas/ontology/entity.schema.json`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/schemas/ontology/entity.schema.json)
...
Same as [`entity.schema.json`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/schemas/ontology/entity.schema.json):
...
See [`examples/ontology/entities/Contract.cqe`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/examples/ontology/entities/Contract.cqe).
