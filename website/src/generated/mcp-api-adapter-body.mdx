...
**Essay:** [Seven surfaces, one catalog](https://pragmaticvectors.com/posts/mcp-api-adapter/) (draft: [`docs/gtm/pragmaticvectors/mcp-api-adapter.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/gtm/pragmaticvectors/mcp-api-adapter.md))  
...
- Essay: [Seven surfaces, one catalog](https://pragmaticvectors.com/posts/mcp-api-adapter/) · draft [`../gtm/pragmaticvectors/mcp-api-adapter.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/gtm/pragmaticvectors/mcp-api-adapter.md)
