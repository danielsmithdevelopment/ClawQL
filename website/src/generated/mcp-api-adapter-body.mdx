...
| **[ClawQL Streams](/streams/clawql-streams)** (draft) | Event-driven agents; WebSocket sources into Core                 |
...
- Protocol Fabric / event loop (draft): [`docs/streams/clawql-streams.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/streams/clawql-streams.md)
  > > > > > > > 19d2cfe7 (docs(mcp-api-adapter): language-agnostic upstream + mcpo positioning)
