...
**Essay:** [Seven surfaces, one catalog](https://pragmaticvectors.com/posts/mcp-api-adapter-five-surfaces/) (draft: [`docs/gtm/pragmaticvectors/mcp-api-adapter-seven-surfaces.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/gtm/pragmaticvectors/mcp-api-adapter-seven-surfaces.md) — publish as update to that URL)  
...
**Planned seventh surface:** [QR stream transport](/streams/clawql-qr-stream-transport) — physical optical channel for air-gapped MCP and Streams event sources (unidirectional by default; optional bidirectional).
...
Together with ClawQL Core (APIs → MCP), this is the **[Protocol Fabric](/mcp/protocol-fabric)** — MCP as the common IR in both directions.
...
- Essay: [Seven surfaces, one catalog](https://pragmaticvectors.com/posts/mcp-api-adapter-five-surfaces/) · draft [`../gtm/pragmaticvectors/mcp-api-adapter-seven-surfaces.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/gtm/pragmaticvectors/mcp-api-adapter-seven-surfaces.md)
