...
Related: [Custom sources](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/getting-started/custom-sources.md) registers upstream MCP servers **into** ClawQL. `mcp-api-adapter` exposes an MCP server **outward** to non-MCP clients.
...
| **[Custom sources](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/getting-started/custom-sources.md)** | Register other MCP servers **into** the ClawQL gateway |
