...
Seven API sources on the left, **ClawQL Core + mcp-api-adapter** at the center, seven transport layers on the right. **WORM Audit Log** and **HTMX / MCP-UI** sit below the hub. Assets: [`images/clawql-protocol-fabric.webp`](images/clawql-protocol-fabric.webp) (site) · PNG fallback [`images/clawql-protocol-fabric.png`](images/clawql-protocol-fabric.png).
