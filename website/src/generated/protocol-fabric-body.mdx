...
**Depends on:** ClawQL Core (`search` / `execute` / `memory_*`) · [`mcp-api-adapter`](/mcp/mcp-api-adapter) `@0.6+` · [`mcp-grpc-transport`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/mcp-grpc-transport)  
**Smoke:** [`scripts/dev/smoke-protocol-fabric-loop.sh`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/scripts/dev/smoke-protocol-fabric-loop.sh) · design notes in [`protocol-fabric-loop-benchmark.md`](/mcp/protocol-fabric#proven-end-to-end-loop)
