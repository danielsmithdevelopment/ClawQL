...
**Verify shipped vs roadmap:** [`docs/clawql-ecosystem.md`](/vision/roadmap) (appendix **Fiction and roadmap**) and [`docs/security/clawql-security-defense-deliverables.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/clawql-security-defense-deliverables.md).
