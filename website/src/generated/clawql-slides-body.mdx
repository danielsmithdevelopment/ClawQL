...
**Verify shipped vs roadmap:** [`docs/clawql-ecosystem.md`](/vision/ecosystem) (appendix **Fiction and roadmap**) and [`docs/security/clawql-security-defense-deliverables.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/clawql-security-defense-deliverables.md).
...
- **15** bundled vendor specs in `BUNDLED_PROVIDERS` (GitHub, Cloudflare, Slack, Sentry, n8n, Linear, Tika, Gotenberg, Paperless, Stirling, Onyx, **Nextcloud**, **Coneshare**, Jira, Bitbucket) plus **`google`** / **`all-providers`** presets — see [`providers/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/providers/README.md)
...
**Recipe:** **`DEFAULT_IDP_PIPELINE`** in **`clawql-documents`** — see [`idp-pipeline.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/providers/idp-pipeline.md).
...
_Threat modeling, immutability, supply chain, zero trust, recovery, and how ClawQL maps to each layer. **Full** reference: [`docs/security/clawql-security-defense-in-depth.md`](/security/defense-in-depth)._
...
- Pointers: **NIST** SP 800-207, **CISA** Zero Trust, **CIS** Kubernetes benchmark, **MITRE ATT&CK**, **SLSA**, **Sigstore**, **NIST** CSF 2.0 — all expanded in [`../security/clawql-security-defense-in-depth.md`](/security/defense-in-depth) with **discussion** **questions** and **hands-on** **lab** ideas.
- **Engineering audit trail:** [`../security/clawql-security-defense-deliverables.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/clawql-security-defense-deliverables.md) — control → **status** → **issue** → **Helm/CI/docs** artifact matrix ([#164](https://github.com/danielsmithdevelopment/ClawQL/issues/164)).
- **Agentic AI security curriculum (30 modules):** [`../security/security-best-practices-series/README.md`](/security/best-practices) — supply chain through operator security; on-site at **/security/best-practices** (sections I–X).
...
**Ready for production pilots.** Public MCP + lending / RWA + **optional Fabric** on a **Q2 2026** track (see **slides 50–55**, **57**). **Security** **defense in depth** (slides **68–79** + [`../security/clawql-security-defense-in-depth.md`](/security/defense-in-depth)).
...
| Defense in depth (reference)            | [`../security/clawql-security-defense-in-depth.md`](/security/defense-in-depth) (slides **68–79**)                                                                                                                                              |
| Security curriculum (30 modules)        | [`../security/security-best-practices-series/README.md`](/security/best-practices)                                                                                                                                                              |
| Defense in depth (deliverables / audit) | [`../security/clawql-security-defense-deliverables.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/clawql-security-defense-deliverables.md) ([#164](https://github.com/danielsmithdevelopment/ClawQL/issues/164)) |
