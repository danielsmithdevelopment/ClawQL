...
**Essay (why ontology beats memory alone — OpenBench B-7 proof):** [Memory Finds. Ontology Decides.](https://pragmaticvectors.com/posts/memory-finds-ontology-decides/) · draft copy [`docs/gtm/pragmaticvectors/memory-finds-ontology-decides.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/gtm/pragmaticvectors/memory-finds-ontology-decides.md) · legal pack [`legal-domain-v0.1`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/specs/ontology/legal-domain-v0.1.md) · structured filters [`memory-recall-structured-filter-v0.1`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/specs/memory/memory-recall-structured-filter-v0.1.md) · [OpenBench B-7](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/openbench-b7-calderwood.md)
