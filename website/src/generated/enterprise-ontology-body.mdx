...
**Security ↔ ontology loop:** typed denials/demotions as knowledge (`SecurityEvent`, `FailedStrategy`), append-only evidentiary fields, coverage lint — [`security-ontology-knowledge-loop.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/security-ontology-knowledge-loop.md).
