...
| `memory_ingest`             | Memory            | Writes durable Markdown under the vault; insights, receipts, `enterpriseCitations`, wikilinks ([`memory-obsidian.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/memory-obsidian.md)).                                              |
