...
See [`clawql-celld.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/streams/clawql-celld.md) for the full runtime matrix and workarounds.
...
Logical **AuditSidecar** remains the in-session writer API; under celld it maps to `storage.put` + LTX. See [`clawql-durable-objects.md`](/streams/clawql-durable-objects) and [`clawql-celld.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/streams/clawql-celld.md).
...
Partial Web Crypto: `digest`, HMAC sign/verify, AES-GCM, RSA-OAEP decrypt, Ed25519 / ECDSA-P256 sign, `getRandomValues`, `randomUUID`. Missing: `deriveKey` / `deriveBits` / wrap-unwrap, broader verify, `DigestStream`. Streams and sidecars must not depend on unavailable primitives — see [`clawql-celld.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/streams/clawql-celld.md) §2.
...
Operational detail: [`clawql-celld.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/streams/clawql-celld.md) §7.
...
- [`docs/streams/clawql-celld.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/streams/clawql-celld.md) — celld integration: constraints, DO classes, bucket layout, deploy
