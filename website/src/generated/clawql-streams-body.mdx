...
**Related:** [`mcp-api-adapter`](/mcp/mcp-api-adapter) (MCP → APIs) · [Agentic Gateway](/inference/clawql-inference) · [Ouroboros](../ouroboros/)
...
- [`docs/inference/clawql-inference.md`](/inference/clawql-inference) — Agentic Gateway / inference path
