...
**Companions:** [`clawql-tee-airgap-audit.md`](/streams/clawql-tee-airgap-audit) · [`clawql-streams`](/streams/clawql-streams) v0.2 · [`clawql-inference`](/inference/clawql-inference)  
...
5. **QR air-gap transport** — audit reaches verifier on a channel the operator cannot influence ([spec](/streams/clawql-tee-airgap-audit))
