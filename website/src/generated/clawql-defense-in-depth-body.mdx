...
- **Local Privacy Filter** — optional second gateway pass after Presidio ([#245](https://github.com/danielsmithdevelopment/ClawQL/issues/245)); [`privacy-filter-local.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/security/privacy-filter-local.md)
