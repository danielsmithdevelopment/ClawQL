...
**Cursor iOS:** Cloud Agents have no local **`~/.ClawQL`** on the phone — configure dashboard Secrets, stdio MCP, and end-of-session **`memory_sync`**. Full walkthrough: [cursor-ios-cloud-agent.md](/getting-started/cursor-ios-cloud-agent).
...
- [Cursor iOS + Cloud Agent](/getting-started/cursor-ios-cloud-agent)
