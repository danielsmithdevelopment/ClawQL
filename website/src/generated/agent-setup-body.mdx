...
| Running clawql-inference (`/v1`)     | [Inference setup](/getting-started/inference)                        |
...
**Related:** [For teams — Team vault sync](/getting-started/for-teams#team-vault-sync) · [MCP clients](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/readme/deployment.md)
...
1. **Object-storage bucket** with a team prefix (R2 quick start: [For teams — R2](/getting-started/for-teams#quick-start-r2)).
...
For **S3** or **GCS**, use the credential variables from [For teams — Environment](/getting-started/for-teams#environment) instead of R2 keys.
...
**`memory_sync`** replaces shell **`clawql sync push`** / **`pull`** on Cloud Agents. See [For teams — `memory_sync`](/getting-started/for-teams#memory-sync-mcp-tool).
...
[`docs/benchmarks/openbench-github-actions.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/openbench-github-actions.md).
...
- [For teams — Team vault sync](/getting-started/for-teams#team-vault-sync)
