...
**Related:** [Team vault sync](/getting-started/team-vault-sync) · [MCP clients](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/readme/deployment.md)
...
**`memory_sync`** replaces shell **`clawql sync push`** / **`pull`** on Cloud Agents. See [team-vault-sync.md — `memory_sync`](/getting-started/team-vault-sync#memory_sync-mcp-tool).
