  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-claw-cyan/10 ring-1 ring-claw-cyan/25 ring-inset'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-claw-cyan transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
            ...
            <Tab
              className={clsx(
                ...
                childIndex === selectedIndex
                  ? 'border-claw-cyan text-claw-cyan'
