    ...
    const tools = [
      {
        ...
        description:
          'Navigate to a page on this documentation site. Use paths like /learn, /learn/search-and-execute-mcp, /learn/external-ingest-knowledge, /learn/knowledge-search-onyx, /learn/document-pipeline, /learn/sandbox-exec, /learn/effect-ts, /learn/memory, /learn/ouroboros-tools, /learn/openclaw-and-clawql, /learn/schedule-notify-workflows, /learn/cache-handoff-between-chats, /learn/audit-tool-and-observability, /tools, /install, /deployment, /kubernetes, /docker-desktop-observability, or /spec-configuration. Only same-origin relative paths are allowed.',
        inputSchema: {
