...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-claw-cyan/10 py-1 pr-3 pl-1.5 text-sm text-[#134e4a] ring-1 ring-claw-cyan/25 ring-inset dark:bg-claw-cyan/5 dark:text-zinc-200 dark:ring-claw-cyan/30">
        <CheckIcon className="h-5 w-5 flex-none fill-[#0e7490] stroke-white dark:fill-claw-cyan/20 dark:stroke-claw-cyan" />
