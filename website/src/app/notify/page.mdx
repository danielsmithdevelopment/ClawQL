...
**Learn walkthrough** (with **`schedule`**, synthetics, HITL): [Schedule & notify workflows](/learn/schedule-notify-workflows).

**Canonical guide (setup, `notify` vs `execute`, thread replies, Block Kit, errors, Cursor JSON, Helm):** [notify-tool.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/notify-tool.md) · [mcp-tools.md § notify](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/mcp-tools.md#notify-optional) · issue [#77](https://github.com/danielsmithdevelopment/ClawQL/issues/77).
...
Repo tests: **`src/clawql-notify.test.ts`**, **`src/server.test.ts`**. Follow-up issues: [#136](https://github.com/danielsmithdevelopment/ClawQL/issues/136)–[#140](https://github.com/danielsmithdevelopment/ClawQL/issues/140) — index **[backlog/archive/notify-tool-test-backlog.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/backlog/archive/notify-tool-test-backlog.md)**.
