...
**Related:** [Authentication](/auth) (auth events dual-write into this trail) · [Observability](/observability) (LGTM+ runtime telemetry — different surface) · [Audit tool & observability](/learn/audit-tool-and-observability) (in-process MCP `audit` ring buffer — different surface)
