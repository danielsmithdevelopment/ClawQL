...
<Note>
  **Canonical write-up (full detail):** [`docs/case_studies/cloudflare-docs-site-mcp-workflow.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/case_studies/cloudflare-docs-site-mcp-workflow.md) — this page is the readable summary on **docs.clawql.com**.
</Note>
