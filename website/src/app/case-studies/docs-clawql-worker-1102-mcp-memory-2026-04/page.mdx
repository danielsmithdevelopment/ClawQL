...
export const sections = caseStudyWorker1102McpMemorySections

<CaseStudyStructuredData
  headline="Case study: docs.clawql.com Worker limits, MCP search/execute, and memory_ingest (Apr 2026)"
  path="/case-studies/docs-clawql-worker-1102-mcp-memory-2026-04"
  description="Incident: Error 1102 and waitUntil cancellations; Cloudflare API debugging via ClawQL MCP; vault memory_ingest postmortem; Lighthouse CI and prevention runbook."
/>
...
- **Lighthouse in CI** (added after this incident) improves **lab** accessibility/SEO/client metrics on **`next start`** but does **not** measure **Workers isolate CPU**—documented plainly in **[`docs/website/website-performance-workers-guardrails.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/website/website-performance-workers-guardrails.md)**.
...
- **Synthetic uptime** for `/`, `/api/health`, and **one case-study path** (ties to [`docs/schedule-synthetic-checks.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/schedule-synthetic-checks.md)).
