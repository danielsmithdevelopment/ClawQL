...
- **Deploy script:** [`scripts/deploy-docs-to-cloudflare.sh`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/scripts/deploy-docs-to-cloudflare.sh)
- **Lighthouse assert:** [`scripts/assert-lighthouse-scores.mjs`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/scripts/assert-lighthouse-scores.mjs)
