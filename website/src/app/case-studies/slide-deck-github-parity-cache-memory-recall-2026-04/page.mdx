...
**Full deck (this site):** [/vision/slide-deck](/vision/slide-deck) — same Markdown as the canonical file below; loaded as a **separate async chunk** from this case study page.
