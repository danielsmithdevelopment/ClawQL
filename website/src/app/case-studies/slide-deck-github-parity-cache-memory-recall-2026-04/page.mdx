...
| **#163** | **Transcript** parity: [`clawql-slides-transcript.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/presentations/clawql-slides-transcript.md) vs **80** slides + **§08** |
