...
<CaseStudyStructuredData
  headline="Case study: TrueNAS Scale (`corgicave`) — homelab networking, Mac client `errno 49`, vault memory, and SSH hardening (April 2026)"
  path="/case-studies/truenas-scale-corgicave-homelab"
  description="Full narrative: office switch island, Mac mini dual-homing and utun/Docker, memory_ingest/recall, Thunderbolt vs SSH, resolution and SSH hardening — same detail as docs/case_studies in the repo."
/>
