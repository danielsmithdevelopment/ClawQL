...
5. **Ops:** **Helm** `enableAudit` in [`charts/clawql-mcp`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/charts/clawql-mcp); [`docs/deployment/deploy-k8s.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/deployment/deploy-k8s.md), [`docs/deployment/helm.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/deployment/helm.md).
