...
<CaseStudyStructuredData
  headline="Case study: OpenClaw agent chat → ClawQL `memory_recall` — cross-session vault knowledge (June 2026)"
  path="/case-studies/openclaw-clawql-memory-recall-2026-06"
  description="Full agent chat transcript: OpenClaw calls clawql__memory_recall and returns vault notes from prior sessions — validation for solo builders using agent gateways."
/>

<Note>
  **Source:** This page and
  [`docs/case_studies/openclaw-clawql-memory-recall-agent-chat-2026-06.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/case_studies/openclaw-clawql-memory-recall-agent-chat-2026-06.md)
  are kept in **sync**.
</Note>
