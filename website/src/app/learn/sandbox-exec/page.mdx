...
| **Managed host (Kata)**  | Production VM/EC2 tiers — Packer bake + Pulumi provision                                    | [Golden host images](/getting-started/golden-host-images)               |
...
- [Golden host images](/getting-started/golden-host-images) — Packer + Pulumi for managed AWS/GCP/Cloudflare tiers (Kata escalation in-cluster).
