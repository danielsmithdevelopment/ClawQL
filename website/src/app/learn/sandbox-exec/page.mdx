...
| **`clawql sandbox` CLI** | **Full agent harness** containment (Codex, Claude, Cursor, OpenCode) — fail-closed Seatbelt | [Local agent sandbox](/getting-started/local-agent-sandbox) |
...
- [Local agent sandbox](/getting-started/local-agent-sandbox) — `clawql sandbox init`, per-harness Seatbelt, fail-closed harness launch.
