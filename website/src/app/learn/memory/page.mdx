...
**Canonical repo docs:** [memory-obsidian.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/memory-obsidian.md) · [MCP tools § memory](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/mcp-tools.md) · [Architecture](/architecture)
