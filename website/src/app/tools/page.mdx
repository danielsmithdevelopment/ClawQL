export const metadata = {
  title: 'Tools',
  description:
    'ClawQL MCP tools: search and execute; optional sandbox_exec, memory_ingest, memory_recall, ingest_external_knowledge. Same tools over stdio, Streamable HTTP, or optional gRPC (mcp-grpc-transport).',
}
