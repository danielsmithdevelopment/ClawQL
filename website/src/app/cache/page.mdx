...
**Canonical reference (operations, semantics, multi-replica, issue table):** [cache-tool.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/cache-tool.md) · [mcp-tools.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp-tools.md). **[#75](https://github.com/danielsmithdevelopment/ClawQL/issues/75)** is **closed** (Core **`cache`** shipped); **[#29](https://github.com/danielsmithdevelopment/ClawQL/issues/29)** is **open** (unrelated: index negative-cache discovery).
