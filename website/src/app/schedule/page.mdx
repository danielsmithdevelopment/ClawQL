...
[schedule-synthetic-checks.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/schedule-synthetic-checks.md) ·
[mcp-tools.md § schedule](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/mcp-tools.md#schedule-optional) ·
issue [#76](https://github.com/danielsmithdevelopment/ClawQL/issues/76).

**Learn walkthrough** (with **`notify`**, built-in failure/recovery bridge, HITL): [Schedule & notify workflows](/learn/schedule-notify-workflows).
