...
redaction, validates against ``benchmarks/openbench/schema/openbench-trace.v1.json``, and
...
SCHEMA_PATH = ROOT / "benchmarks" / "openbench" / "schema" / "openbench-trace.v1.json"
SCHEMA_VERSION = "1.1"
