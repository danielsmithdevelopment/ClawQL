...
Usage:
  python benchmarks/extractbench/scripts/apply_clawql_provider.py \\
...
{begin}
    # =========================================================================
    # ClawQL IDP (overlay from danielsmithdevelopment/ClawQL benchmarks/extractbench)
    # =========================================================================
...
def main() -> int:
    ...
    print("\nDone. Next:")
    print("  cd", root)
    print("  # start ClawQL MCP with IDP flags (see benchmarks/extractbench/scripts/)")
