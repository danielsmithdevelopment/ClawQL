...
# Overlay
python /path/to/ClawQL/benchmarks/extractbench/scripts/apply_clawql_provider.py \
  --extractbench "$PWD"
...
# ClawQL MCP
/path/to/ClawQL/benchmarks/extractbench/scripts/start-clawql-for-extractbench.sh 8080
