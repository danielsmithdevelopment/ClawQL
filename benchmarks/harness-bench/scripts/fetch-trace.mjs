 ...
 *
 * Usage:
 *   node benchmarks/harness-bench/scripts/fetch-trace.mjs
 *   TRACE_BASE=http://127.0.0.1:8090/mcp-ui node benchmarks/harness-bench/scripts/fetch-trace.mjs demo-compressed
