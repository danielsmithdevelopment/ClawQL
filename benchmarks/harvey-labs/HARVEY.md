...
export CLAWQL_LAB_PREINGEST_SCRIPT="$PWD/ClawQL/benchmarks/harvey-labs/scripts/lab-pre-ingest.mjs"
export CLAWQL_LAB_MCP_PROXY="$PWD/ClawQL/benchmarks/harvey-labs/scripts/lab-mcp-proxy.mjs"

# Apply overlay — copies OUR files + minimal run.py hooks only
python3 ClawQL/benchmarks/harvey-labs/scripts/apply_clawql_adapter.py \
