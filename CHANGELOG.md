...
- **Ontology-enriched Fast Decision scoring** — ClawQL capability ontology (`clawql-capability-ontology.json`) maps MCP tools/skills/anti-patterns with whenToUse/whenNotToUse; held-out + GLiNER classify pack ontology into `text`/`labels` (opt out: `CLAWQL_FAST_DECISION_ONTOLOGY=0`).
