...
- **`clawql-observability` version reset to `0.1.0`** for first npm publish — replaces in-tree `0.7.0` phase-tracking label and draft `0.2.0` release-note assumption. Policy: [`docs/release/clawql-observability-versioning.md`](docs/release/clawql-observability-versioning.md). Checklist: [`docs/release/clawql-observability-0.1.0-checklist.md`](docs/release/clawql-observability-0.1.0-checklist.md). Package changelog: [`packages/clawql-observability/CHANGELOG.md`](packages/clawql-observability/CHANGELOG.md).
