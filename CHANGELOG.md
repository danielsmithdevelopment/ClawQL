...
- **LangExtract extraction layer** ([#246](https://github.com/danielsmithdevelopment/ClawQL/issues/246)): MCP **`extract_document`** when **`CLAWQL_ENABLE_LANGEXTRACT=1`** — grounded extractions via **`LANGEXTRACT_BASE_URL`** or local heuristic; reference Python sidecar (`deployment/samples/langextract-http/`), threat model, onboarding doc.
