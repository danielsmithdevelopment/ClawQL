...
- **v0.4 frontier productionTrusted** — GHA run 36144911649 (PR #1147 marker): live Sonnet 4.6 + gliner2 on `fast-decision-held-out-v0.4-routing-fresh` → acc 0.80 / MCE 0.118 / `productionTrusted=true`; frontier GT ≡ provisional 40/40; @τ=0.70 cov 0.45, 18/18 among-accepted. Summaries under `fixtures/frontier-runs/`.
