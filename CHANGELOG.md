...
- **Frozen v0.6 routing-fresh confirmation suite** — `fast-decision-held-out-v0.6-routing-fresh` (n=75) isolated catalog draft; digests in `FREEZE-v0.6-routing-fresh.md`; `resolveHeldOutSuite("v0.6-routing-fresh")`. Score-once GHA 36199128704 + frontier 36199128630: Decide @ τ=0.80 → 39/75 fires, 2 errors among fires (≈83% LB). Live cite remains twin-aware v0.5 rematch; closeout `DECIDE_V06_CONFIRMATION_CLOSEOUT.md`.
