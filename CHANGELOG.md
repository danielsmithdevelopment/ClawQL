...
=======
- **§7 frontier-judge HTTP sidecar + optional GHA** — `scripts/frontier-judge-http-server.mts` (Anthropic Messages / OpenRouter) implementing `CLAWQL_FAST_DECISION_JUDGE_URL`; workflow `.github/workflows/fast-decision-frontier-adjudication.yml` (workflow_dispatch, credential-gated like Harvey LAB).
>>>>>>> origin/main
