...
- **Security status page ([#1033](https://github.com/danielsmithdevelopment/ClawQL/pull/1033))** — `/security/status` with published scan-history evidence (pass/fail retained); CI publish workflow; `SECURITY.md`; spec [`docs/design/security-status-page-spec.md`](docs/design/security-status-page-spec.md).
- **Effect v4 Stage 0 ([#1037](https://github.com/danielsmithdevelopment/ClawQL/pull/1037))** — spike inventory + try-RC workflow/CI; no runtime Effect bump in 8.0 (forward-looking only).
- **Docs polish ([#1039](https://github.com/danielsmithdevelopment/ClawQL/pull/1039), [#1040](https://github.com/danielsmithdevelopment/ClawQL/pull/1040))** — mobile content padding; live `/archive` pages.
- **Streams celld v0.4.0 lab + Helm ([#1041](https://github.com/danielsmithdevelopment/ClawQL/pull/1041), [#1042](https://github.com/danielsmithdevelopment/ClawQL/pull/1042))** — Lab 5 local smoke on celld **v0.4.0**; Helm `celld` stack templates + `values-streams-celld.example.yaml`; onboarding `streams` CLI; [`docs/streams/clawql-celld.md`](docs/streams/clawql-celld.md).
- **Streams celld AgentSessionDO path ([#1043](https://github.com/danielsmithdevelopment/ClawQL/pull/1043)–[#1047](https://github.com/danielsmithdevelopment/ClawQL/pull/1047))** — embed `clawql-core` **streams-slim** (Workers-safe, no webmcp/fs); Streamable HTTP MCP `search`/`execute` fetch; `memory_ingest`/`memory_recall` via MCP; `mcp-api-adapter` REST fetch; isolate audit ring → DO LTX storage. Example: [`examples/streams-celld/`](examples/streams-celld/).
