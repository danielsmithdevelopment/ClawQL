...
- **Frozen v0.6 routing-fresh confirmation suite** — `fast-decision-held-out-v0.6-routing-fresh` (n=75) isolated catalog draft; digests in `FREEZE-v0.6-routing-fresh.md`; `resolveHeldOutSuite("v0.6-routing-fresh")`; Decide score-once + frontier markers. Optional confirmation of already-live Decide path (T=0.75 / τ=0.80); not a τ retune.
