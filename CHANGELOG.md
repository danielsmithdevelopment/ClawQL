...
- **Fresh routing held-out v0.3** — `fast-decision-held-out-v0.3-routing-fresh` (34 cases) drafted by an isolated model session from tool catalog only; frozen with SHA-256 digests in `FREEZE-v0.3-routing-fresh.md` before any hint text. Select via `--suite v0.3-routing-fresh`.
