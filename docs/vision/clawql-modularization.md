...
> **Companion only (v1.9, May 2026).** **Do not use for 7.0 shipped vs planned claims.** **Canonical vision** is [`clawql-master-enablement-guide.md`](./clawql-master-enablement-guide.md). **Implementation ground truth:** [`../design/modularization-implementation-status.md`](../design/modularization-implementation-status.md). **Operator guide for Phase 1:** [`../getting-started/phase-1-platform-guide.md`](../getting-started/phase-1-platform-guide.md). [`clawql-modularization-v2.md`](./clawql-modularization-v2.md) adds gateway/orchestration notes.
