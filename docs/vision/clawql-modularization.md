...
| Per-request enforcement | `clawql-api`                    | Auth middleware on every search/execute; bind JWT ATR at the Agentic Gateway in production stacks ([`mcp-proxy-jwt-atr.md`](../security/mcp-proxy-jwt-atr.md), comprehensive guide §3 / §5)  |
