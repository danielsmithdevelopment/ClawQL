...
| Managed Edge Gateway       | 🚧 Shipped CLI (`clawql gateway create` / `status` / `destroy`); Dedicated VG boot after vault sync (Packer/Pulumi `startManagedGateway`); Helm `managedGateway` (off by default) — production hardening in progress                                                                                                                                                              |
| `clawql-data`              | 📋 Planned                                                                                                                                                                                                                                                                                                                                                                         |
