...
*ClawQL Vision & Roadmap · July 2026 · Apache 2.0 / MIT*
*For implementation contracts: see the [Contributor Technical Specification](https://docs.clawql.com/contributing/technical-specification).*
*For planned Operator / CRD deployment: see [Operator target architecture](https://docs.clawql.com/design/operator-target-architecture). Shipped installs: [Deployment & Operations Guide](https://docs.clawql.com/deployment/operations-guide).*
