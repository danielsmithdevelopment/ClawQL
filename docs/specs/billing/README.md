...
| [customer-dashboard-full-scope-v0.1.md](./customer-dashboard-full-scope-v0.1.md) | `clawql-payments` `/credits/org` + `src/dashboard/` | Topology tree + embedded traces (8.0.0 bar)   |
