...
| -------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [webmcp-tool-drafting-v0.1.md](./webmcp-tool-drafting-v0.1.md) | `packages/clawql-core/src/providers/webmcp-draft/` | [ClawQL plugin architecture 8.0](../../design/clawql-core-plugin-architecture.md) · [PixelDrop smart-upload demo](../../../docs/examples/mcp-api-adapter/pixeldrop/README.md) |
