...
| `codegraph_index`, `codegraph_import_graphify`, `codegraph_query`, `codegraph_neighbors`, `codegraph_path`, `codegraph_explain`, `codegraph_subgraph` | **`CLAWQL_ENABLE_CODEGRAPH=1`**; memory tier on                                                                                                 | Structural code graph via **`clawql-codegraph`** — [codegraph plugin](../plugins/codegraph.md); hybrid: **`CLAWQL_MEMORY_RECALL_HYBRID_CODEGRAPH=1`**                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| gRPC MCP                             | `ENABLE_GRPC`, `ENABLE_GRPC_REFLECTION`                                                                                                                                                            | off                         | Same tools over gRPC (**`GRPC_PORT`**, optional reflection); see README and [`packages/mcp-grpc-transport/README.md`](../../packages/mcp-grpc-transport/README.md). Planned OpenAPI on-ramp (`POST /{toolName}` via gRPC `CallTool`): [`design/mcp-openapi-gateway.md`](../design/mcp-openapi-gateway.md).                                                                                                                                                                                                                                                                                           |
