...
| `data_query`, `data_ingest`, `data_status`                                                                                                                                                                                                  | **`CLAWQL_ENABLE_DATA=1`**                                                                                                                      | Node DuckDB structured SQL (`packages/clawql-data`). Not Python `duckdb`. Not chDB. Read-only `SELECT`/`WITH`. Ingest `matters` / `matter_documents`.                                                                                                                                                                                                                                                                                                                                                                                                                           |
