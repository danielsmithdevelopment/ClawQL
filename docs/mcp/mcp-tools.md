...
| `codegraph_index`, `codegraph_sync_graphify`, `codegraph_import_graphify`, `codegraph_query`, `codegraph_neighbors`, `codegraph_path`, `codegraph_explain`, `codegraph_subgraph` | **`CLAWQL_ENABLE_CODEGRAPH=1`**; memory tier on                                                                                                 | Structural code graph via **`clawql-codegraph`** — [codegraph plugin](../plugins/codegraph.md); preferred Graphify sync: **`codegraph_sync_graphify`**; hybrid: **`CLAWQL_MEMORY_RECALL_HYBRID_CODEGRAPH=1`**                                                                                                                                                                                                                                                                                                                                                                   |
