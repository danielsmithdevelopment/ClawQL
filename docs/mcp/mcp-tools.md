...
| `codegraph_index`, `codegraph_query`, `codegraph_neighbors`, `codegraph_path`, `codegraph_explain`, `codegraph_subgraph`            | **`CLAWQL_ENABLE_CODEGRAPH=1`**; memory tier on                                                                                                  | Structural code graph (Graphify-style) via **`clawql-codegraph`** — [codegraph plugin](../plugins/codegraph.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
