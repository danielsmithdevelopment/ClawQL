...
**Tracking:** Onyx epic [#118](https://github.com/danielsmithdevelopment/ClawQL/issues/118) (closed) · **Post-Paperless index push (workflow + `execute`):** [#120](https://github.com/danielsmithdevelopment/ClawQL/issues/120) — bundled **`onyx_ingest_document`** + optional default **Ouroboros** hook (`CLAWQL_OUROBOROS_ONYX_AFTER_PAPERLESS` + seed **`metadata.onyx_ingest_after_paperless`**) · **Vault citation handoff:** [#130](https://github.com/danielsmithdevelopment/ClawQL/issues/130) (closed: **`enterpriseCitations`** + helpers) · **Further tests (live/VCR, transport parity):** [#144](https://github.com/danielsmithdevelopment/ClawQL/issues/144) · **Deck / slides accuracy:** [#145](https://github.com/danielsmithdevelopment/ClawQL/issues/145) · Implementation: [`packages/clawql-documents/src/plugin/knowledge-search-onyx.ts`](../../packages/clawql-documents/src/plugin/knowledge-search-onyx.ts) (root [`src/knowledge-search-onyx.ts`](../src/knowledge-search-onyx.ts) is a thin re-export), [`providers/onyx/openapi.yaml`](../providers/onyx/openapi.yaml), [`packages/clawql-ouroboros/src/glue/default-engines.ts`](../../packages/clawql-ouroboros/src/glue/default-engines.ts) · Full MCP matrix: **[mcp-tools.md](mcp-tools.md)**.
