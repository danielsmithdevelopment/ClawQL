...
**Status:** Implemented for **Markdown bulk import** and **opt-in URL fetch** ([#40](https://github.com/danielsmithdevelopment/ClawQL/issues/40)). **Full-repo GitHub** and **Notion / Confluence / Slack workspaces / Linear / Jira** connectors are specified in **[roadmap/knowledge-lake-roadmap.md](../roadmap/knowledge-lake-roadmap.md)** (phased implementation).
...
- **[roadmap/knowledge-lake-roadmap.md](../roadmap/knowledge-lake-roadmap.md)** — GitHub whole-repo + SaaS knowledge lake (issues, docs, configs; then Notion, Confluence, Slack workspaces, Linear, Jira).
