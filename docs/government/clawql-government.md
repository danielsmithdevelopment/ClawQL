...
**Related:** [`clawql-surveillance`](../surveillance/clawql-surveillance.md) · [`clawql-qr-stream-transport`](../streams/clawql-qr-stream-transport.md) · [`clawql-tee-airgap-audit`](../streams/clawql-tee-airgap-audit.md) · [industry page](https://clawql.com/industries/government/)
...
On-site state auditors without network access to the agency VPC can still receive program WORM trails via the [QR stream transport](../streams/clawql-qr-stream-transport.md) and [TEE air-gap audit](../streams/clawql-tee-airgap-audit.md) path: `auditor_export` → QR sequence (HDMI or thermal) → `clawql-tee-verifier` on the auditor's device. The air gap is preserved; Merkle + optional TEE attestation make the export independently verifiable.

[`clawql-surveillance`](../surveillance/clawql-surveillance.md) authenticates footage / evidence integrity for government technology contracts; this vertical tracks whether those contracts delivered promised **outcomes**.
...
- [`docs/surveillance/clawql-surveillance.md`](../surveillance/clawql-surveillance.md)
- [`docs/streams/clawql-qr-stream-transport.md`](../streams/clawql-qr-stream-transport.md)
- [`docs/streams/clawql-tee-airgap-audit.md`](../streams/clawql-tee-airgap-audit.md)
- [`docs/streams/clawql-streams.md`](../streams/clawql-streams.md)
