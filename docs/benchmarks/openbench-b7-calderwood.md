...
| B-7.1-blind    | `institutional-knowledge-enumerate-blind`    | Same fixture; **no taught filter JSON**                             | Retired WIN (see ledger / CI matrix)                                                                                                                                                                                                             |
| B-7.2          | `institutional-client-preference`            | Meridian Capital prose preference; top-1 term sheet                 | Retired WIN (see ledger / CI matrix)                                                                                                                                                                                                             |
| B-7.3          | `institutional-amortized-session`            | Same vault; 5 related prompts; cost + completeness                  | Live pack — session harness (Q1 build + Q2–5 reuse); burn for on ≫ off                                                                                                                                                                           |
