...
| B-7.1-blind    | `institutional-knowledge-enumerate-blind`    | Same fixture; **no taught filter JSON**                             | Active — invent structured call from tool schema                                                                                                                                                                                                   |
| B-7.2          | `institutional-client-preference`            | Meridian Capital prose preference; top-1 term sheet                 | Active — top-1 grader; docs GT at `b7-ground-truth/b7-2-meridian-preference.md`                                                                                                                                                                     |
