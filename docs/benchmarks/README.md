...
| [`harvey-lab-frozen-protocol.md`](harvey-lab-frozen-protocol.md)                                           | **FROZEN** publishable standard (2026-09-03): matched Lightning±ClawQL, live IDP, Sonnet 4.6, paid OpenRouter only.                                              |
| [`harvey-lab-clawql-results.md`](harvey-lab-clawql-results.md)                                             | Harvey LAB × ClawQL results ledger (filter through frozen protocol §8 — many rows unciteable).                                                                   |
| [`harvey-lab-pause-handoff.md`](harvey-lab-pause-handoff.md)                                               | **Pause/resume** for LAB × ClawQL (GHA + OpenRouter + Arm C).                                                                                                    |
| [`harvey-lab-action-plan.md`](harvey-lab-action-plan.md)                                                   | August 2026 plan reconciliation — **partially superseded** by frozen protocol.                                                                                   |
...
| [`../homelab/personal-agent-hermes-cline.md`](../homelab/personal-agent-hermes-cline.md)                   | **Personal agent** — Hermes/Ornith + Cline/Ornith on Mac Mini (Nemotron fallback if smoke fails; ATR, WORM, Telegram); related to but distinct from LAB smoke.   |
