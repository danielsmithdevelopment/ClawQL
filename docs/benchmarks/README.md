...
| [`harvey-lab-python-duckdb-postmortem.md`](harvey-lab-python-duckdb-postmortem.md)                         | **Postmortem** — why Python DuckDB / patched-harness work was wasted and traces must be discarded.                                                               |
| [`harvey-lab-ts-v2-smoke-gate.md`](harvey-lab-ts-v2-smoke-gate.md)                                         | **Operator checklist** — quarantine → build → task 001 Node DuckDB gate → contiguous 001–025.                                                                    |
