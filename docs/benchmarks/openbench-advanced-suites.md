...
| B2.3   | Scheduled **integration** job with real services (not `pr_active`)                                                                                   | XL   | ✅ Scaffold: [idp-pipeline-smoke.yml](../../.github/workflows/idp-pipeline-smoke.yml) · [runbook](../runbooks/idp-pipeline-b23-smoke.md) |
