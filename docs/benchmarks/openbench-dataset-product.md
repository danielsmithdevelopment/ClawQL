...
| Piece           | Name                                                                   | Role                                                                   |
| --------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| Schema          | **OpenBenchTrace** v1.1                                                | Stable, citable session/trial record (outer envelope + required `rtp`) |
| Inner structure | **RTP** (Reasoning Trace Protocol)                                     | Domain-agnostic six-node reasoning; projected from messages/tools      |
