...
| ---------------------------- | --------------------------------------------------------------------------------- |
| `harness/adapters/clawql.py` | `benchmarks/harvey-labs/harness/adapters/clawql.py` (+ `clawql_lab_session.py`) |
...
| Vault isolation test         | `benchmarks/harvey-labs/tests/test_vault_isolation.py`                          |
