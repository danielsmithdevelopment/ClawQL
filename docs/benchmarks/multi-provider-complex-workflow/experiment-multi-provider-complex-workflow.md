...
- **After:** using the emitted workflow output summarized in [`../archive/multi-provider-workflow-run.md`](../archive/multi-provider-workflow-run.md) (historical full capture: git history for `multi-provider-test.md`)
...
| Search steps   | `5`                                                    |
| Search queries | `14`                                                   |
| Output file    | historical `multi-provider-test.md` (see archive note) |
