...
| -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [gcp-multi-workflow-run.md](gcp-multi-workflow-run.md)                                 | `npm run workflow:gcp-multi` → [`scripts/mcp-workflow-gcp-multi.mjs`](../../../scripts/mcp-workflow-gcp-multi.mjs)                  |
| [multi-provider-workflow-run.md](multi-provider-workflow-run.md)                       | `npm run workflow:multi-provider` → [`scripts/workflow-gke-cloudflare-jira.mjs`](../../../scripts/workflow-gke-cloudflare-jira.mjs) |
