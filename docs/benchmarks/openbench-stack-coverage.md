...
| `run_idp_pipeline` / classify / extract | IDP hops via execute           | **Live WIN** stub `idp-safe-pipeline-lite` ([31039035892](https://github.com/danielsmithdevelopment/ClawQL/actions/runs/31039035892)); **B2.2** resilience WIN ([31139014771](https://github.com/danielsmithdevelopment/ClawQL/actions/runs/31139014771)); **B2.3** scheduled compose smoke | Compose/live tiers + staging secrets ([runbook](../runbooks/idp-pipeline-b23-smoke.md)) |
...
23. **`institutional-knowledge-enumerate` (B-7.1)** — fair same-files cell live (prior on-without-files burns confounded). Sonnet re-burn pending.
