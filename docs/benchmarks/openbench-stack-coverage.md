...
| `run_idp_pipeline` / classify / extract | IDP hops via execute           | **Live WIN** stub `idp-safe-pipeline-lite` ([31039035892](https://github.com/danielsmithdevelopment/ClawQL/actions/runs/31039035892)) | Live vendor matrix = scheduled B2.3, not PR                                             |
