...
**See also:** [`providers/README.md`](../../providers/README.md) (merged presets), [`README.md`](../README.md) (precedence for `CLAWQL_SPEC_PATHS`, `CLAWQL_BUNDLED_PROVIDERS`, and `CLAWQL_PROVIDER`; with none set, the catalog is empty and `all-providers` must be opted into explicitly).
