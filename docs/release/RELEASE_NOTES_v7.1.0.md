...
→ Announcement drafts: [`docs/announcements/announcement-drafts-v7.1.0.md`](../announcements/announcement-drafts-v7.1.0.md) · Prior major: [`RELEASE_NOTES_v7.0.0.md`](RELEASE_NOTES_v7.0.0.md)
...
- Docs site: **`/architecture/enterprise-ontology`** + CQ extension pages; backlog [`docs/ontology/essay-gap-closure.md`](../ontology/essay-gap-closure.md).
- CI **Ontology lint (examples)**; schema in-package; `clawql release` ontology verify + doctor checks.

→ [`docs/architecture/enterprise-ontology.md`](../architecture/enterprise-ontology.md) · [`docs/memory/okf.md`](../memory/okf.md)
...
| Sync `DeductionService` on inference          | [`deduction-service.md`](../payments/deduction-service.md)   |
...
See [`docs/release/v7.1.0-checklist.md`](v7.1.0-checklist.md).
