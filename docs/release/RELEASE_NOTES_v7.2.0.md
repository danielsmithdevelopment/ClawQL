...
→ Announcement drafts: [`docs/announcements/announcement-drafts-v7.2.0.md`](../announcements/announcement-drafts-v7.2.0.md) · Prior minor: [`RELEASE_NOTES_v7.1.0.md`](RELEASE_NOTES_v7.1.0.md) · Checklist: [`docs/release/v7.2.0-checklist.md`](v7.2.0-checklist.md)
...
→ [`docs/memory/okf.md`](../memory/okf.md) · [`docs/memory/hybrid-memory-backends.md`](../memory/hybrid-memory-backends.md)
...
- New **opt-in** memory knobs: `CLAWQL_MEMORY_BACKEND=git`, `CLAWQL_MEMORY_RECALL_HYBRID=1`, index-first / RRF toggles — see [`docs/memory/okf.md`](../memory/okf.md).
...
See [`docs/release/v7.2.0-checklist.md`](v7.2.0-checklist.md).
