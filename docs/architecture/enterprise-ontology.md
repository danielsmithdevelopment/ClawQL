...
**Essay (why ontology beats memory alone — OpenBench B-7 proof):** [Memory Finds. Ontology Decides.](https://pragmaticvectors.com/posts/memory-finds-ontology-decides/) · draft copy [`docs/gtm/pragmaticvectors/memory-finds-ontology-decides.md`](../gtm/pragmaticvectors/memory-finds-ontology-decides.md) · site: [structured filters](https://docs.clawql.com/specs/memory/memory-recall-structured-filter) · [legal domain](https://docs.clawql.com/specs/ontology/legal-domain) · repo: [`legal-domain-v0.1`](../specs/ontology/legal-domain-v0.1.md) · [`memory-recall-structured-filter-v0.1`](../specs/memory/memory-recall-structured-filter-v0.1.md) · [OpenBench B-7](../benchmarks/openbench-b7-calderwood.md)

**Security ↔ ontology loop:** typed denials/demotions as knowledge (`SecurityEvent`, `FailedStrategy`), append-only evidentiary fields, coverage lint — [`security-ontology-knowledge-loop.md`](../security/security-ontology-knowledge-loop.md).
...
**Proof point (OpenBench B-7):** vault `memory_recall` alone still scored **zero** on institutional enumeration when semantic near-misses became false positives. Typed predicates via `clawql-ontology` (`schema` + `filters` over `ontology.db`) closed the set. Narrative + linked GHA runs: [Memory Finds. Ontology Decides.](https://pragmaticvectors.com/posts/memory-finds-ontology-decides/).
...
Provisional shape (YAML or OKF frontmatter + body). Full example: [`docs/examples/ontology/`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/ontology).
...
JSON Schema for validation: [`packages/clawql-ontology/schemas/ontology/entity.schema.json`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-ontology/schemas/ontology/entity.schema.json).
...
CLI reference: [`docs/ontology/cli.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/ontology/cli.md). Examples: [`docs/examples/ontology/`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/ontology). SQL `sources:` are declarations / stubs in v1 — not a live query path.
...
- Example entity: [`docs/examples/ontology/entities/Contract.cqe`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/ontology/entities/Contract.cqe)
- Example decision note: [`docs/examples/ontology/okf/decision-rationale-template.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/ontology/okf/decision-rationale-template.md)
- JSON Schema: [`packages/clawql-ontology/schemas/ontology/entity.schema.json`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-ontology/schemas/ontology/entity.schema.json)
