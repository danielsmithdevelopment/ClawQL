...
**Essay (why ontology beats memory alone — OpenBench B-7 proof):** [Memory Finds. Ontology Decides.](https://pragmaticvectors.com/posts/memory-finds-ontology-decides/) · draft copy [`docs/gtm/pragmaticvectors/memory-finds-ontology-decides.md`](../gtm/pragmaticvectors/memory-finds-ontology-decides.md) · legal pack [`legal-domain-v0.1`](../specs/ontology/legal-domain-v0.1.md) · structured filters [`memory-recall-structured-filter-v0.1`](../specs/memory/memory-recall-structured-filter-v0.1.md) · [OpenBench B-7](../benchmarks/openbench-b7-calderwood.md)
