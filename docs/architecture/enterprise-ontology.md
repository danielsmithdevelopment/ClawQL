...
This matches existing team vault sync ([getting-started-for-teams](../getting-started/getting-started-for-teams.md)): OKF standardizes file shape inside the bucket; it does not change the storage model.
