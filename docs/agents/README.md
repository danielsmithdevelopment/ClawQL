...
| Document                                                                                     | Use                                                                                                   |
| -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [`clawql-agents-spec-v0.1.md`](clawql-agents-spec-v0.1.md)                                   | **Phase 1 scaffold** — Cline adapter in `packages/clawql-agents/`.                                    |
...
| [`../openclaw/using-openclaw-with-clawql.md`](../openclaw/using-openclaw-with-clawql.md)     | Current OpenClaw MCP client guides (no adapter package).                                              |
