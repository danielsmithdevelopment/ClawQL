...
- **`mcp-api-adapter.md`** — **Seven Surfaces, One Catalog** → publish at [pragmaticvectors.com/posts/mcp-api-adapter/](https://pragmaticvectors.com/posts/mcp-api-adapter/); redirect old `/posts/mcp-api-adapter-five-surfaces/` here
