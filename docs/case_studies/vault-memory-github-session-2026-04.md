...
| **Starter artifact** | `apps/docs/public/.well-known/payments.json` placeholder + `/.well-known/*` cache headers — ties to #88 / #87 (docs deploy)                                                                                                                                                                                                                                                                                 |
...
6. **Website & Cursor:** site copy ([`apps/docs/src/app/tools/page.mdx`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/apps/docs/src/app/tools/page.mdx), related MDX), [`.cursor/skills/clawql-vault-memory/SKILL.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/.cursor/skills/clawql-vault-memory/SKILL.md) — clarifies `audit` vs vault.
