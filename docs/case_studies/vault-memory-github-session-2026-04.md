...
2. **Code:** [`src/clawql-audit.ts`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-audit) — `append` / `list` / `clear`; unconditional registration in [`src/tools.ts`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-api); optional flags in [`src/clawql-optional-flags.ts`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-api) cover other tools.
3. **Tests:** [`src/clawql-audit.test.ts`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-audit), extended optional-flags + stdio smoke ([`src/server.test.ts`](https://github.com/danielsmithdevelopment/ClawQL/tree/main/packages/clawql-api)).
