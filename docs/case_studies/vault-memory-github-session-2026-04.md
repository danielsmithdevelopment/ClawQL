...
| **Operator trail**    | **`audit()`** (optional, in-process ring buffer) | Not the vault; not compliance-grade logging by itself — see [`docs/mcp/enterprise-mcp-tools.md`](../mcp/enterprise-mcp-tools.md). |
...
- **Documentable** — pairs naturally with [`docs/mcp/enterprise-mcp-tools.md`](../mcp/enterprise-mcp-tools.md) threat-model language.
...
1. **Design:** [`docs/mcp/enterprise-mcp-tools.md`](../mcp/enterprise-mcp-tools.md) — flags, threat model, future `metrics` / `governance`.
...
4. **Docs / env:** [`docs/mcp/mcp-tools.md`](../mcp/mcp-tools.md), [`.env.example`](../../.env.example), [`README.md`](../../README.md), [`CHANGELOG.md`](../../CHANGELOG.md).
...
- **MCP tools:** [mcp-tools.md](../mcp/mcp-tools.md)
- **Enterprise design:** [enterprise-mcp-tools.md](../mcp/enterprise-mcp-tools.md)
