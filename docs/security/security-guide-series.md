...
> **Modular site / CMS:** Thirty standalone modules with frontmatter live under [`security-best-practices-series/`](security-best-practices-series/README.md). Regenerate from this monolith with `node tools/security-curriculum-v30/extract-bodies-from-monolith.mjs` then `node tools/security-curriculum-v30/build-modules.mjs`.
