...
> **Archived monolith — do not edit for site changes.** Canonical curriculum: [`../security-best-practices-series/`](../security-best-practices-series/README.md) (30 modules) and [`../security-curriculum-v30/`](../security-curriculum-v30/README.md). Website MDX is generated by `apps/docs/scripts/sync-security-training-modules.mjs` — edit sources only, not `apps/docs/src/generated/security-training/`.

> **Historical note:** This file was the single long-form export. Regenerate module bodies from it only via `node docs/security/security-curriculum-v30/extract-bodies-from-monolith.mjs` (paths point at this archive copy).
