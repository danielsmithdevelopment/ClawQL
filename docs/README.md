...
- **Enterprise Ontology** (open versioned schema · OKF · kinetic `@kinetic` · Git vs R2): [`architecture/enterprise-ontology.md`](architecture/enterprise-ontology.md) — [`/architecture/enterprise-ontology`](https://docs.clawql.com/architecture/enterprise-ontology) — [ADR 0009](adr/0009-enterprise-ontology.md) — CLI: [`ontology/cli.md`](ontology/cli.md) (`clawql ontology lint` / `generate`) — **essay gap closure:** [`ontology/essay-gap-closure.md`](ontology/essay-gap-closure.md) — **`.cq*` extensions:** [ADR 0010](adr/0010-cq-file-extensions.md) · [`specs/cq-extensions/`](specs/cq-extensions/) — **Command Deck builder UX:** [`architecture/command-deck-ontology-builder-ux.md`](architecture/command-deck-ontology-builder-ux.md)
...
- **clawql-inference** (gateway, export/finetune, payments integration): [`inference/clawql-inference.md`](inference/clawql-inference.md); PorTAL flywheel intentions: [`inference/portal-flywheel.md`](inference/portal-flywheel.md)
- **mcp-grpc-transport 1.0** (MCP 2026-07-28 stateless gRPC): [`packages/mcp-grpc-transport`](../packages/mcp-grpc-transport/README.md)
- **MCP OpenAPI Gateway** (✅ `0.3.0` — any MCP → OpenAPI + GraphQL + gRPC): [`design/mcp-openapi-gateway.md`](design/mcp-openapi-gateway.md) · user guide [`mcp/mcp-openapi-gateway.md`](mcp/mcp-openapi-gateway.md) · package [`packages/mcp-openapi-gateway`](../packages/mcp-openapi-gateway/README.md) · example [`examples/mcp-openapi-gateway`](../examples/mcp-openapi-gateway/README.md)
...
- Design docs: [`design/effect-ts-modularization-rearchitecture-plan.md`](design/effect-ts-modularization-rearchitecture-plan.md) (Effect-TS + modularization + plugins), [`design/mcp-openapi-gateway.md`](design/mcp-openapi-gateway.md) (📋 MCP tools → OpenAPI on-ramp over gRPC), [`design/OPENAPI_TO_GRAPHQL_UPSTREAM.md`](design/OPENAPI_TO_GRAPHQL_UPSTREAM.md), [`design/graphql-mesh-node-compatibility.md`](design/graphql-mesh-node-compatibility.md); archived drafts: [`design/archive/`](design/archive/); vector / recall design notes live under **`memory/`** (e.g. [`memory/vector-search-design.md`](memory/vector-search-design.md)); **`.cq*` format specs:** [`specs/cq-extensions/`](specs/cq-extensions/)
...
- Announcements: `announcements/` — **7.1.0 drafts:** [`announcements/announcement-drafts-v7.1.0.md`](announcements/announcement-drafts-v7.1.0.md); **7.0.0 drafts:** [`announcements/announcement-drafts-v7.0.0.md`](announcements/announcement-drafts-v7.0.0.md); release checklist: [`release/v7.1.0-checklist.md`](release/v7.1.0-checklist.md)
...
- GTM: [`gtm/pragmaticvectors/`](gtm/pragmaticvectors/) (PV essay drafts); **MCP OpenAPI on-ramp positioning:** [`gtm/mcp-openapi-gateway-positioning.md`](gtm/mcp-openapi-gateway-positioning.md)
