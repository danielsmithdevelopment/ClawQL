...
- **ClawQL payments** (Stripe + x402 + MPP, plan entitlements, WORM audit): [`payments/clawql-payments.md`](payments/clawql-payments.md); accounting/tax handoff (design): [`payments/accounting-and-tax.md`](payments/accounting-and-tax.md)
