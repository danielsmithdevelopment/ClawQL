...
- GTM: [`gtm/pragmaticvectors/`](gtm/pragmaticvectors/) (PV essay drafts); **MCP API adapter positioning:** [`gtm/mcp-api-adapter-positioning.md`](gtm/mcp-api-adapter-positioning.md)
