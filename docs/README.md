...
- **Enterprise Ontology** (open versioned schema · OKF · kinetic `@kinetic` · Git vs R2): [`architecture/enterprise-ontology.md`](architecture/enterprise-ontology.md) — [ADR 0009](adr/0009-enterprise-ontology.md) — CLI: [`ontology/cli.md`](ontology/cli.md) (`clawql ontology lint` / `generate`) — **`.cq*` extensions:** [ADR 0010](adr/0010-cq-file-extensions.md) · [`specs/cq-extensions/`](specs/cq-extensions/) — **Command Deck builder UX:** [`architecture/command-deck-ontology-builder-ux.md`](architecture/command-deck-ontology-builder-ux.md)
