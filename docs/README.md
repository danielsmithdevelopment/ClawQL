...
- `design/clawql-desktop-macos.md` — ClawQL Desktop (macOS Electron app) — source: [`../apps/desktop`](../apps/desktop/) · UI: [`../apps/dashboard`](../apps/dashboard/)
...
- **IDP umbrella Helm chart** (`manifests/charts/clawql-idp`, full profile): [`deployment/clawql-idp-helm.md`](deployment/clawql-idp-helm.md)
- **IDP observability bundle** (Grafana + trace/metrics guide, #252): [`observability/README.md`](observability/README.md)
- **`clawql-observability` package** (LGTM+ npm **`0.1.0`** first publish): [`design/clawql-observability-package-spec.md`](design/clawql-observability-package-spec.md) · provider registry [`design/clawql-observability-provider-registry.md`](design/clawql-observability-provider-registry.md) · versioning [`release/clawql-observability-versioning.md`](release/clawql-observability-versioning.md) · publish checklist [`release/clawql-observability-0.1.0-checklist.md`](release/clawql-observability-0.1.0-checklist.md) · [docs.clawql.com/observability](https://docs.clawql.com/observability)
- **Workspace npm versioning (`0.1.0` first publish):** [`release/clawql-workspace-package-versioning.md`](release/clawql-workspace-package-versioning.md) · checklist [`release/workspace-packages-0.1.0-checklist.md`](release/workspace-packages-0.1.0-checklist.md) · targets [`../scripts/release/package-npm-version-targets.json`](../scripts/release/package-npm-version-targets.json)
...
- **Hosted live bootstrap** (Pulumi profiles + Argo CD + `.cqw`): [`deployment/hosted-live-bootstrap.md`](deployment/hosted-live-bootstrap.md) · [`infra/pulumi`](../infra/pulumi/) · [`infra/gitops`](../infra/gitops/) · [`infra/gitops/workflows`](../infra/gitops/workflows/) · hosted-edge Workers (lags 8.0.0): [`infra/cloudflare`](../infra/cloudflare/)
...
- **Security ↔ ontology knowledge loop** (ATR as grammar-adversarial validation, typed denials, FailedStrategy, capability Gate 3): [`security/security-ontology-knowledge-loop.md`](security/security-ontology-knowledge-loop.md)
...
## Benchmarks, case studies, and samples

- Benchmarks (specs): `benchmarks/`
- Case studies: `case_studies/` — docs site hub [`/examples`](https://docs.clawql.com/examples)
- Sample / not-ready-to-use stacks: [`examples/`](examples/) (Compose, IDP sidecars/fixtures, ontology `.cqe`, Streams celld, managed gateway). Docs site [`/examples`](https://docs.clawql.com/examples) is case-study walkthroughs, not this folder.
...
- Integrations: `integrations/` — MCP chokepoint / Panguard + Helm **`mcpProxy`**: [`integrations/panguard-kubernetes.md`](integrations/panguard-kubernetes.md), [`integrations/panguard-http-grpc-bridge.md`](integrations/panguard-http-grpc-bridge.md); JWT ATR binding: [`security/mcp-proxy-jwt-atr.md`](security/mcp-proxy-jwt-atr.md) ([#272](https://github.com/danielsmithdevelopment/ClawQL/issues/272)); standalone WORM packages: [`security/clawql-audit-standalone.md`](security/clawql-audit-standalone.md); security↔ontology event loop: [`security/security-ontology-knowledge-loop.md`](security/security-ontology-knowledge-loop.md)
...
- Workflows: `workflows/`
- Docs-site operations runbooks: [`docs/website/`](website) (not the Next app at `apps/docs/`)
