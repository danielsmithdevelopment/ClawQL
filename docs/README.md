...
- **MCP OpenAPI Gateway** (🚧 MVP — MCP tools → named REST + OpenAPI; gRPC `CallTool` backend): [`design/mcp-openapi-gateway.md`](design/mcp-openapi-gateway.md) · package [`packages/mcp-openapi-gateway`](../packages/mcp-openapi-gateway/README.md) · example [`examples/mcp-openapi-gateway`](../examples/mcp-openapi-gateway/README.md)
