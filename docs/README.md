...
- **MCP API Adapter** (✅ `0.4.0` — any MCP → OpenAPI + GraphQL + gRPC): [`design/mcp-api-adapter.md`](design/mcp-api-adapter.md) · user guide [`mcp/mcp-api-adapter.md`](mcp/mcp-api-adapter.md) · package [`packages/mcp-api-adapter`](../packages/mcp-api-adapter/README.md) · example [`examples/mcp-api-adapter`](../examples/mcp-api-adapter/README.md)
