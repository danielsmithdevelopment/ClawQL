...
- **Enterprise Ontology** (open versioned schema · OKF · kinetic `@kinetic` · Git vs R2): [`architecture/enterprise-ontology.md`](architecture/enterprise-ontology.md) — [`/architecture/enterprise-ontology`](https://docs.clawql.com/architecture/enterprise-ontology) — [ADR 0009](adr/0009-enterprise-ontology.md) — CLI: [`ontology/cli.md`](ontology/cli.md) (`clawql ontology lint` / `generate`) — **essay (B-7 proof):** [Memory Finds. Ontology Decides.](https://pragmaticvectors.com/posts/memory-finds-ontology-decides/) · draft [`gtm/pragmaticvectors/memory-finds-ontology-decides.md`](gtm/pragmaticvectors/memory-finds-ontology-decides.md) — **essay gap closure:** [`ontology/essay-gap-closure.md`](ontology/essay-gap-closure.md) — **`.cq*` extensions:** [ADR 0010](adr/0010-cq-file-extensions.md) · [`specs/cq-extensions/`](specs/cq-extensions/) — **Command Deck builder UX:** [`architecture/command-deck-ontology-builder-ux.md`](architecture/command-deck-ontology-builder-ux.md)
...
- **MCP API Adapter** (✅ in-repo `0.6.0` — npm **not published yet**; any MCP → OpenAPI + GraphQL + `/mcp` + gRPC + `/ws` + gen-cli): docs site [`/mcp/mcp-api-adapter`](https://docs.clawql.com/mcp/mcp-api-adapter) · [`design/mcp-api-adapter.md`](design/mcp-api-adapter.md) · user guide [`mcp/mcp-api-adapter.md`](mcp/mcp-api-adapter.md) · package [`packages/mcp-api-adapter`](../packages/mcp-api-adapter/README.md) · example [`examples/mcp-api-adapter`](../examples/mcp-api-adapter/README.md) · essay [Seven surfaces, one catalog](https://pragmaticvectors.com/posts/mcp-api-adapter-five-surfaces/) (draft [`gtm/pragmaticvectors/mcp-api-adapter-seven-surfaces.md`](gtm/pragmaticvectors/mcp-api-adapter-seven-surfaces.md)) · [Protocol Fabric](gtm/protocol-fabric.md) · fabric loop [`design/protocol-fabric-loop-benchmark.md`](design/protocol-fabric-loop-benchmark.md) · smoke [`scripts/dev/smoke-mcp-api-adapter.sh`](../scripts/dev/smoke-mcp-api-adapter.sh) / [`scripts/dev/smoke-protocol-fabric-loop.sh`](../scripts/dev/smoke-protocol-fabric-loop.sh)
