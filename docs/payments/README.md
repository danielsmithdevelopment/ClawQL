...
| [**org-credits.md**](org-credits.md)                                                     | Company billing admins               | Closed-loop company pool, role budgets, within-org transfers                                            |
| [**customer-provisioning-core.md**](customer-provisioning-core.md)                       | Operators / integrators              | `provisionOrg`, dual triggers, Checkout metadata, CF→Node handoff, CLI                                  |
| [**stripe-products-ops.md**](stripe-products-ops.md)                                     | Ops enabling live Checkout / meters  | Stripe Products, Prices, meters, webhook checklist                                                      |
| [**Enterprise control plane**](../enterprise/control-plane.md)                           | CFO / IT / operators                 | SSO domains, user admin, unified spend, Prometheus                                                      |
