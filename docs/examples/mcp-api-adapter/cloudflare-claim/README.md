...
```bash
node docs/examples/mcp-api-adapter/cloudflare-claim/e2e-webmcp-bridge.mjs
```

## Local mirror (optional)

```bash
WEBMCP_PAGE_URL=http://127.0.0.1:8765/ node docs/examples/mcp-api-adapter/cloudflare-claim-server.mjs
```
