...
async function main() {
  ...
  console.log("  node docs/examples/mcp-api-adapter/demo-rest.mjs");
  console.log("  node docs/examples/mcp-api-adapter/demo-graphql.mjs");
  console.log("  node docs/examples/mcp-api-adapter/demo-grpc.mjs");
  console.log("  node docs/examples/mcp-api-adapter/demo-all.mjs");
  console.log("");
