...
**Getting started:** [`docs/getting-started/inference.md`](../../getting-started/inference.md) · **Reference:** [`docs/inference/clawql-inference.md`](../../inference/clawql-inference.md) · **Package:** [`packages/clawql-inference`](../../../packages/clawql-inference)
...
```bash
export CLAWQL_INFERENCE_POLICY_MANIFEST="$(pwd)/docs/examples/inference/policy.yaml"
```
...
- [Token efficiency layers](../../architecture/clawql-token-efficiency.md)
- [Inference provider plugins](../../plugins/inference-providers.md)
- [Payments / entitlements](../../payments/clawql-payments.md)
