...
Use this addendum with the [OpenClaw IDP skill profile](../../../openclaw/openclaw-idp-skill-profile.md) when the operator asks to process a title commitment for a residential transaction.
...
Use synthetic fixtures from docs/examples/idp/real-estate-title/ for demos only.
