...
Use this addendum with the [OpenClaw IDP skill profile](../../../openclaw/openclaw-idp-skill-profile.md) when the operator asks to process a W-2 for underwriting.
...
Use synthetic fixtures from docs/examples/idp/lending-w2/ for demos only.
