...
```bash
kubectl apply -f docs/examples/idp/lending-w2/workflow-template.yaml -n clawql
```
...
See [docling-onboarding.md](../../../providers/docling-onboarding.md).
...
- Runbook: [`docs/runbooks/nats-idp-e2e.md`](../../../runbooks/nats-idp-e2e.md)
- Values: [`manifests/charts/clawql-mcp/values-nats-idp.example.yaml`](../../../manifests/charts/clawql-mcp/values-nats-idp.example.yaml)
...
Use [`openclaw-prompt.md`](openclaw-prompt.md) as a system prompt addendum. Full IDP defaults: [openclaw-idp-skill-profile.md](../../../openclaw/openclaw-idp-skill-profile.md). Agent NATS contract: [clawql-agent-idp-nats.md](../../../openclaw/clawql-agent-idp-nats.md) ([#128](https://github.com/danielsmithdevelopment/ClawQL/issues/128)).

## Related

- [Argo workflows README](../../../infra/gitops/argo-workflows/README.md)
- [HITL Label Studio](../../../mcp/hitl-label-studio.md)
- [Multi-reviewer RBAC (CE two-person pattern)](../../../mcp/hitl-label-studio.md#14-multi-reviewer-rbac-ce-vs-enterprise) ([#249](https://github.com/danielsmithdevelopment/ClawQL/issues/249))
- [Fine-tuned classifier runbook](../../../runbooks/fine-tuned-classifier.md)
- [NATS IDP e2e](../../../runbooks/nats-idp-e2e.md)
- [workflow MCP tool](../../../mcp/workflow-tool.md)
