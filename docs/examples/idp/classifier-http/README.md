...
Minimal **heuristic** classifier for local IDP demos. **Do not** use in production — train and deploy your tenant model per [`docs/runbooks/fine-tuned-classifier.md`](../../../runbooks/fine-tuned-classifier.md).
...
```bash
node docs/examples/idp/classifier-http/server.mjs
...
```bash
docker build -t clawql-classifier-reference docs/examples/idp/classifier-http
...
See [`docs/runbooks/fine-tuned-classifier.md`](../../../runbooks/fine-tuned-classifier.md).
