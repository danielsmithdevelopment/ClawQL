...
Use this addendum with the [OpenClaw IDP skill profile](../../../openclaw/openclaw-idp-skill-profile.md) when the operator asks to process a purchase and sale agreement for a residential transaction.
...
Use fixtures from docs/examples/idp/real-estate-psa/ for demos only.
```
