...
```bash
python docs/examples/idp/langextract-http/server.py
...
See [`docs/security/langextract-threat-model.md`](../../../security/langextract-threat-model.md). **Default-off** in ClawQL; demo mode sends no text to cloud LLMs.

## Docker

```bash
docker build -t clawql-langextract-reference docs/examples/idp/langextract-http
