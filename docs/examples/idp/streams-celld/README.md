...
Helm overlay: [`manifests/charts/clawql-mcp/values-streams-celld.example.yaml`](../../../manifests/charts/clawql-mcp/values-streams-celld.example.yaml)

Worker skeleton: [`docs/examples/streams-celld/`](../../streams-celld/)
...
2. **Deploy Worker bundle** — from repo root:
   ...
   ```bash
   cd docs/examples/streams-celld
...
- [celld integration spec](../../../streams/clawql-celld.md)
- [ClawQL Streams spec](../../../streams/clawql-streams.md)
