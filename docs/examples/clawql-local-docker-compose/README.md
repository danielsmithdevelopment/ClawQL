...
Docs: [`docs/security/privacy-filter-local.md`](../../security/privacy-filter-local.md).
...
Full walkthrough: [`docs/examples/inference/README.md`](../inference/README.md) · Reference: [clawql-inference](/inference/clawql-inference).
...
For Kubernetes parity, use `make local-k8s-up` and [`manifests/charts/clawql-mcp`](../../manifests/charts/clawql-mcp).
