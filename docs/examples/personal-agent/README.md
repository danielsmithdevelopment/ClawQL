...
Operator guide: [`docs/homelab/personal-agent-hermes-cline.md`](../../homelab/personal-agent-hermes-cline.md)
...
```bash
docker compose -f docs/examples/personal-agent/docker-compose.loki.yml up -d
```
