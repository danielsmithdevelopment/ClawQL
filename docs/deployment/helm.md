...
| `provider`                                                        | **`CLAWQL_PROVIDER`** (default **`default`** — npm parity; use **`all-providers`** for full IDP merge; e.g. **`google`**) — for custom id lists, set container env **`CLAWQL_BUNDLED_PROVIDERS`**.                                                                                                                                                                                                                                                                                 |
