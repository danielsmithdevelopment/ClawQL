...
| ------------------------ | -------------------------------------------------- | ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Edge Worker**       | Developer / Teams / trial / demo                   | Cloudflare Worker + R2 / KV / D1                                                           | Phase 1 shipped; **lags ClawQL 8.0.0** ([`infra/cloudflare/gateway`](../../infra/cloudflare/gateway), [must-update note](../../infra/cloudflare/README.md)) |
...
| **4. Helm Managed Edge** | In-cluster one-hostname edge                       | `manifests/charts/clawql-mcp` `managedGateway` (off by default)                            | Wedge + hardening (non-root, NetworkPolicy); JWT ATR on MCP upstream                                                                                        |
