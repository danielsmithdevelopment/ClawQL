...
- **[external-ingest.md](../mcp/external-ingest.md)** — current tool behavior and env.
- **[memory-db-hybrid-implementation.md](../memory/memory-db-hybrid-implementation.md)** — `memory.db`, chunking, vectors.
- **[hybrid-memory-backends.md](../memory/hybrid-memory-backends.md)** — Postgres / sqlite-vec.
