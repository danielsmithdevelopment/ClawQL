...
- **Vault default for API keys:** [#241](https://github.com/danielsmithdevelopment/ClawQL/issues/241) — **shipped** [vault-provider-secrets.md](../deployment/vault-provider-secrets.md) · **Vault UI:** [#242](https://github.com/danielsmithdevelopment/ClawQL/issues/242)
