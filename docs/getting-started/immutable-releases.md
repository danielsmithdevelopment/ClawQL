...
Vision (why): [Immutable releases](https://docs.clawql.com/vision/immutable-releases) · source [`docs/vision/clawql-hybrid-decentralized-github-alternative.md`](https://docs.clawql.com/vision/immutable-releases)
...
- Modularization Layer 0: [`docs/vision/clawql-modularization-v2.md`](https://docs.clawql.com/architecture)
