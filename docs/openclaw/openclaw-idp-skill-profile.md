...
| ------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Extract / parse**             | **`execute`** on **`docling`** spec (`DOCLING_BASE_URL`)   | **`DOCLING_BASE_URL`**, optional **`DOCLING_API_KEY`**           | Ready   | [`docling-onboarding.md`](../providers/docling-onboarding.md) — layout-aware forms/tables ([#248](https://github.com/danielsmithdevelopment/ClawQL/issues/248))                                                                                                                                                                      |
...
| **LangExtract / Docling**       | **`execute`** on **`docling`**; LangExtract custom spec    | **`DOCLING_BASE_URL`**                                           | Partial | Docling bundled ([#248](https://github.com/danielsmithdevelopment/ClawQL/issues/248)); classifier runbook: [`fine-tuned-classifier.md`](../runbooks/fine-tuned-classifier.md). LangExtract: [#246](https://github.com/danielsmithdevelopment/ClawQL/issues/246).                                                                  |
...
| Bundled LangExtract / Docling as providers            | Docling **shipped** ([#248](https://github.com/danielsmithdevelopment/ClawQL/issues/248)); LangExtract [#246](https://github.com/danielsmithdevelopment/ClawQL/issues/246); classifier: [`fine-tuned-classifier.md`](../runbooks/fine-tuned-classifier.md) |
