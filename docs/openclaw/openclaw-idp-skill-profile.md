...
| **Pipeline recipe**             | **`DEFAULT_IDP_PIPELINE`** / **`run_idp_pipeline`**        | All vendor base URLs above; `CLAWQL_ENABLE_IDP_PIPELINE=1`               | Ready   | [`idp-pipeline.md`](../providers/idp-pipeline.md), [`idp-pipeline-runner.md`](../mcp/idp-pipeline-runner.md) ([#307](https://github.com/danielsmithdevelopment/ClawQL/issues/307))                                              |
...
| **anydoc**                      | **`convert_document`**                                     | **`CLAWQL_ENABLE_ANYDOC=1`** (in-process; no sidecar)                    | Ready   | [`anydoc-onboarding.md`](../providers/anydoc-onboarding.md) — Office/PDF/CSV → GFM; OCR failures route to Docling                                                                                                               |
