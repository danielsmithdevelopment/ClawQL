...
| **LangExtract / Docling**       | **`execute`** on **`docling`**; **`extract_document`**     | **`DOCLING_BASE_URL`**, **`CLAWQL_ENABLE_LANGEXTRACT=1`**        | Ready   | Docling ([#248](https://github.com/danielsmithdevelopment/ClawQL/issues/248)); LangExtract ([#246](https://github.com/danielsmithdevelopment/ClawQL/issues/246)): [`langextract-onboarding.md`](../providers/langextract-onboarding.md) |
...
| Bundled LangExtract / Docling as providers            | Docling + LangExtract **shipped** ([#248](https://github.com/danielsmithdevelopment/ClawQL/issues/248), [#246](https://github.com/danielsmithdevelopment/ClawQL/issues/246)); classifier: [`fine-tuned-classifier.md`](../runbooks/fine-tuned-classifier.md) |
