...
| [`docling-classifier.compose.yml`](docling-classifier.compose.yml) | **Docling + classifier + LangExtract** ([#248](https://github.com/danielsmithdevelopment/ClawQL/issues/248), [#246](https://github.com/danielsmithdevelopment/ClawQL/issues/246)) | Docling, classifier, LangExtract — point MCP with `CLAWQL_ENABLE_ANYDOC=1` / `CLAWQL_ENABLE_PDF_INSPECTOR=1` for in-process convert/routing |
