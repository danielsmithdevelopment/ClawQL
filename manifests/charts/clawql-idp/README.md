...
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| **`manifests/charts/clawql-mcp`**              | Production MCP-only, custom flags, minimal footprint                                                                    |
| **`manifests/charts/clawql-idp`** (this chart) | k3s / lab **full IDP profile** — document pipeline, OpenClaw, dashboard, workflow/argocd RBAC, NATS, Ouroboros Postgres |
| **Documentation-only stack**         | BYO Argo CD / Langfuse / Label Studio with lean chart + `infra/gitops` manifests                                      |
...
- **Argo Workflows** controller — [`infra/gitops/argo-workflows/README.md`](../../../infra/gitops/argo-workflows/README.md)
