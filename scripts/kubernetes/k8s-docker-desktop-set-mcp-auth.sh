...
#   gh auth token | bash scripts/kubernetes/k8s-docker-desktop-set-mcp-auth.sh
#   CLAWQL_GITHUB_TOKEN=ghp_xxx bash scripts/kubernetes/k8s-docker-desktop-set-mcp-auth.sh
#   CLAWQL_CLOUDFLARE_API_TOKEN=… CLAWQL_GOOGLE_ACCESS_TOKEN="$(gcloud auth print-access-token)" bash scripts/kubernetes/k8s-docker-desktop-set-mcp-auth.sh
#   CLAWQL_LOAD_DOTENV=0 bash scripts/kubernetes/k8s-docker-desktop-set-mcp-auth.sh   # do not source .env
#
