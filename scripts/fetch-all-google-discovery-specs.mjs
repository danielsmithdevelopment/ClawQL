 ...
 *
 * Usage:
 *   node scripts/fetch-all-google-discovery-specs.mjs
 *   node scripts/fetch-all-google-discovery-specs.mjs --limit=5 --dry-run
 *   node scripts/fetch-all-google-discovery-specs.mjs --only-preferred --delay-ms=150
 *
