...
Covers upstream normalization, vault message parsing, SSE parsing, bridge session enrichment (Paperless/Stirling/Onyx/vault citations), and multi-turn session scoping. CI runs `npm run test --prefix dashboard` after root vitest.
