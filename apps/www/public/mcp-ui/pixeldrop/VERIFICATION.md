...
**To add:** Drop `pixeldrop-iphone-heic-demo.mp4` (or similar) under `apps/www/public/mcp-ui/pixeldrop/` and link from README when recorded.
...
node docs/examples/mcp-api-adapter/pixeldrop/webmcp-cdp-smoke.mjs \
