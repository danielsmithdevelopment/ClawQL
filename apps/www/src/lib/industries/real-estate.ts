...
export const realEstateIndustry: Industry = {
  ...
  examples: [
    ...
    },
    {
      ...
      steps: [
        ...
        { label: 'Label Studio', detail: 'Paste label-studio-config.xml from docs/examples/idp/real-estate-title/ or real-estate-psa/.' },
        { label: 'Connect agent', detail: 'Cursor or OpenClaw at http://localhost:8080/mcp.' },
        { label: 'Smoke flow', detail: 'Run title, PSA, or FSBO offer path from docs/examples/idp/real-estate/README.md.' },
      ],
    },
  ],
  compliance: [
  ...
  relatedResources: [
    { label: 'Real estate workflow overview', href: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/real-estate' },
    { label: 'Title commitment sample pack', href: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/real-estate-title' },
    { label: 'PSA sample pack', href: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/real-estate-psa' },
    { label: 'FSBO buyer offer sample pack', href: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/real-estate-fsbo' },
    { label: 'Lending W-2 pack (same pattern)', href: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/lending-w2' },
    { label: 'IDP pipeline reference', href: 'https://docs.clawql.com/providers/idp-pipeline' },
  ],
  docsHref: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/real-estate',
  disclaimer:
