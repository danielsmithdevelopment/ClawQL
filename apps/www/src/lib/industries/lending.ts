...
export const lendingIndustry: Industry = {
  ...
  examples: [
    ...
    },
    {
      ...
      steps: [
        ...
        { label: 'Smoke W-2 flow', detail: 'Run classify → HITL path from docs/examples/idp/lending-w2/README.md.' },
      ],
    },
  ],
  compliance: [
  ...
  relatedResources: [
    { label: 'Lending W-2 sample pack', href: 'https://github.com/danielsmithdevelopment/ClawQL/tree/main/docs/examples/idp/lending-w2' },
