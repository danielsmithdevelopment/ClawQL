...
const nextConfig = {
  ...
  // Node Docker image: traced minimal server + node_modules (see apps/docs/Dockerfile runner stage).
  output: 'standalone',
  // Monorepo: lockfile at repo root caused Next to trace from parent; OpenNext/Workers needs app-root tracing.
  outputFileTracingRoot: __dirname,
  // file:../../packages/clawql-analytics is outside /app in Docker; transpile + resolve deps from apps/docs/node_modules.
