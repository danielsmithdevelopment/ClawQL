...
```yaml
# manifests/charts/clawql-mcp values snippet
mcpProxy:
  enabled: true
  mode: nginx
  replicaCount: 2
...
Copy the full overlay: [`values-mcp-proxy-panguard-bridge.example.yaml`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/manifests/charts/clawql-mcp/values-mcp-proxy-panguard-bridge.example.yaml). Details: [Panguard on Kubernetes (repo)](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/integrations/panguard-kubernetes.md).
