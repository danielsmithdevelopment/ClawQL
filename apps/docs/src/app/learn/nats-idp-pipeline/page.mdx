...
3. **Have a cluster or local NATS** — in-cluster JetStream from `manifests/charts/clawql-mcp` (`nats.enabled=true`) or external `nats.url`.
...
Full umbrella: `manifests/charts/clawql-idp/values-idp-full.yaml` per [clawql-idp-helm.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/deployment/clawql-idp-helm.md).
...
1. Place a PDF at Nextcloud `IDP/inbox/…` (or use [lending W-2](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/idp/lending-w2/README.md) fixtures).
...
Sample pack: [docs/examples/idp/idp-nats-agent](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/idp/idp-nats-agent/README.md) · Contract: [clawql-agent-idp-nats.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/openclaw/clawql-agent-idp-nats.md).
