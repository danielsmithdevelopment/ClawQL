...
**Canonical runbook (architecture, env matrix, Label Studio setup, security, troubleshooting, Helm, tests):** [hitl-label-studio.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/hitl-label-studio.md) · [mcp-tools.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/mcp-tools.md) · issue [#228](https://github.com/danielsmithdevelopment/ClawQL/issues/228).

**Learn walkthrough** (with **`schedule`**, **`notify`**, Slack threads): [Schedule & notify workflows](/learn/schedule-notify-workflows).
...
Full tables and behavior: [hitl-label-studio.md § Configuration](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/hitl-label-studio.md#4-clawql-configuration-reference).
...
Set **`enableHitlLabelStudio: true`** in **`manifests/charts/clawql-mcp`** and inject URL, API token, and webhook token via **`extraEnv`** or **`envFromSecret`**. Ensure **Ingress** exposes **`/hitl/label-studio/webhook`** on the same host you register in Label Studio.
