...
Implementation: packages/mcp-api-adapter/src/mcp-ui-_.ts — catalog page + execute fragment, form UX (required/optional/defaults/Advanced), templates for search / memory\__ / cache / audit. Deferred: nested object/array UIs, file upload/IDP, SSE progress, agent-generated UIs, ATR scoping.
