.cqwPart of .cq\* extensions.On this pagePurposeSerializationRequired ClawQL annotationsTooling hooksNon-goalsExample (illustrative)

title: .cqw — ClawQL Workflow (draft)
...
clawql.dev/requires-mandate

true / false

clawql.dev/mandate-type

AP2 type when required

clawql.dev/correlation-id-param

Workflow param name carrying WORM correlation
