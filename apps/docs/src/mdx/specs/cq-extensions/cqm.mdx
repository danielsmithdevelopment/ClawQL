.cqmPart of .cq\* extensions.On this pagePurposeSerializationRequired top-level fieldsRecommended fieldsTooling hooksNon-goalsExample (illustrative)

title: .cqm — ClawQL Manifest (draft)
...
Semver or release tag

spec

Kind-specific body

spec.ontologySchemaVersion

Pin to Ontology schema generation

spec.compliance

Level, residency, PII handling

spec.kinetic

Default blast-radius / mandate policy
