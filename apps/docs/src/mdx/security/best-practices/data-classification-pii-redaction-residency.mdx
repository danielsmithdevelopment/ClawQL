SecurityTraining · Part 15/32Agentic AI security curriculum · Security overviewOn this pageThe Accidental Data Classification ProblemClassification TaxonomyPresidio Entity DetectionClassification-Gated Tool AccessResidency ControlsAnonymisation for Analytics and TestingKey Takeaways (Memorize These!)Data Classification and PII Redaction: Tagging, Anonymisation, and Residency Controls
