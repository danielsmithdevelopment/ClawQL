SecurityTraining · Part 9/32Agentic AI security curriculum · Security overviewOn this pageWhy Long-Lived Tokens Are an Agentic RiskJWT + ATR Token Exchange at the GatewayOAuth2/OIDC for External Tool CallsNonce-Based Replay PreventionAutomatic Rotation and RevocationMulti-Factor and Device Pairing for Local AccessAudit Logging of Every Authenticated ActionAddendum: Nonce Store AvailabilityKey Takeaways (Memorize These!)Authentication and Session Management: Per-Request Scoped Tokens, OAuth/OIDC, Rotation, and Replay Prevention
