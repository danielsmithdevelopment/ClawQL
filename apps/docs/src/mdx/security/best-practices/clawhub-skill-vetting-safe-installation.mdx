SecurityTraining · Part 3/32Agentic AI security curriculum · Security overviewOn this pageWhy Skills Are a Distinct Supply Chain ProblemCryptographic Manifest Signing and VerificationAutomated Static Analysis with clawql skill lint --strictDependency Confusion Attack SurfaceSandboxed Execution ObservationPer-Agent Allowlists and Quarantine ModePolicy: Never Auto-InstallKey Takeaways (Memorize These!)ClawHub Skill Vetting and Safe Installation: Signature Verification, Sandbox Testing, and Allowlisting
