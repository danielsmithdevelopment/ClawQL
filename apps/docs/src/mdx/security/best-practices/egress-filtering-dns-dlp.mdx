SecurityTraining · Part 6/32Agentic AI security curriculum · Security overviewOn this pageWhy Egress Is the Exfiltration SurfaceIstio ServiceEntry Allowlists and Default-Deny EgressSSRF Prevention for Agent URL ToolsDNS-Layer FilteringDLP Inspection of Outbound Tool Call PayloadsSession-Level Egress Volume DetectionEgress from Sandboxed Skill ExecutionKey Takeaways (Memorize These!)Egress Filtering, DNS Controls, and Data Loss Prevention
