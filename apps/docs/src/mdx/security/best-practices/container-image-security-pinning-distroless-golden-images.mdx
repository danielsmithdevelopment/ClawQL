SecurityTraining · Part 1/32Agentic AI security curriculum · Security overviewOn this pageThe Problem with Unpinned ImagesDigest Pinning — The Cryptographic FixPrivate Mirror Registry with Harbor — Your Single Source of TruthSBOM Generation — Know Exactly What’s InsideDistroless Base Images — Removing the Attacker’s ToolboxThe Golden Image Pipeline — One Hardened Base to Rule Them AllTrivy + OSV-Scanner Integration — Shift-Left ScanningKey Takeaways (Memorize These!)Next Steps &amp; Hands-On ChallengeContainer Image Security: Pinning, Distroless Pipelines, Mirror Registries, and Golden Images
