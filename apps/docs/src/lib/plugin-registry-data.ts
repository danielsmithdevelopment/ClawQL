...
export const pluginRegistryEntries: PluginRegistryEntry[] = [
  ...
  },
  {
    ...
    name: 'Ouroboros',
    description:
      'Evolutionary-loop MCP tools via clawql-harness (always registered) with optional Postgres lineage.',
    category: 'horizontal',
    status: 'shipped',
    ...
    enable: 'always on (clawql-harness); CLAWQL_ENABLE_OUROBOROS deprecated',
    href: '/plugins/ouroboros',
    keywords: ['lineage', 'evolutionary', 'harness'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Human-in-the-loop enqueue + webhook path; full ProviderPlugin wiring still planned.',
    category: 'horizontal',
    status: 'shipped',
    package: 'src/',
