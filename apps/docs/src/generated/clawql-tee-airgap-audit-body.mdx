...
**Hands-on walkthrough:** [Streams getting started (Learn)](https://docs.clawql.com/learn/streams-getting-started) — **§5** TEE + air-gap reading order (with [clawql-tee](/streams/clawql-tee)).

**Status:** Draft · August 2026 · v0.1  
**Component:** `cellrt-attestation` · `cellrt-storage` · `clawql-tee-verifier` (standalone)  
**Depends on:** [`clawql-cellrt`](/streams/clawql-cellrt) v0.1 · [`clawql-tee`](/streams/clawql-tee) v0.1 · AMD SEV-SNP (or TDX) attestation
...
- [`docs/streams/clawql-qr-stream-transport.md`](/streams/clawql-qr-stream-transport) — 7th mcp-api-adapter surface + Streams `qr` source (generalizes this frame format)
- [`docs/streams/clawql-cellrt.md`](/streams/clawql-cellrt) — owned cell runtime
- [`docs/streams/clawql-streams.md`](/streams/clawql-streams) — WORM event types / session lifecycle
- [`docs/government/clawql-government.md`](/government/clawql-government) — auditor on-site QR export consumer
