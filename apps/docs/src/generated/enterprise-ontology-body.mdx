...
**Essay (why ontology beats memory alone — OpenBench B-7 proof):** [Memory Finds. Ontology Decides.](https://pragmaticvectors.com/posts/memory-finds-ontology-decides/) · draft copy [`docs/gtm/pragmaticvectors/memory-finds-ontology-decides.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/gtm/pragmaticvectors/memory-finds-ontology-decides.md) · site: [structured filters](https://docs.clawql.com/specs/memory/memory-recall-structured-filter) · [legal domain](https://docs.clawql.com/specs/ontology/legal-domain) · repo: [`legal-domain-v0.1`](/specs/ontology/legal-domain) · [`memory-recall-structured-filter-v0.1`](/specs/memory/memory-recall-structured-filter) · [OpenBench B-7](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/benchmarks/openbench-b7-calderwood.md)
...
Provisional shape (YAML or OKF frontmatter + body). Full example: [`docs/examples/ontology/`](https://docs.clawql.com/examples/ontology/).
...
CLI reference: [`docs/ontology/cli.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/ontology/cli.md). Examples: [`docs/examples/ontology/`](https://docs.clawql.com/examples/ontology/). SQL `sources:` are declarations / stubs in v1 — not a live query path.
...
- Example entity: [`docs/examples/ontology/entities/Contract.cqe`](https://docs.clawql.com/examples/ontology/entities/Contract.cqe)
