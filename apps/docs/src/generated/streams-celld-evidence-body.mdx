...
Follow [`docs/examples/idp/streams-celld/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/idp/streams-celld/README.md). Helm templates are asserted in CI; live webhook→fleet→LTX is **not** automated yet.
