...
| `sandbox_exec`              | Execution         | Optional — **`CLAWQL_ENABLE_SANDBOX=1`** — bridge / Seatbelt / Docker ([`mcp-tools.md`](/tools) § **`sandbox_exec`**, [`infra/cloudflare/sandbox-bridge/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/infra/cloudflare/sandbox-bridge/README.md)). |
...
- **`manifests/charts/clawql-mcp`** — see [`manifests/charts/clawql-mcp/README.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/manifests/charts/clawql-mcp/README.md) and `values.yaml` for optional document pipeline, Onyx, Flink, NATS, UI ingress, etc.
