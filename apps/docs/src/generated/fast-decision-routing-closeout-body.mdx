...
**Status:** v0.4 stock path remains the historical `productionTrusted` claim on suite v0.4. **Live routing path (v0.6):** Decide @ T=0.75 / τ=0.80 after twin collapse — see [`DECIDE_V06_CUTOVER.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_V06_CUTOVER.md).
...
**How earned.** Not a new freeze. Twin collapse + declared spend rule (equal fire errors → prefer coverage) + rematch of the same v0.5 dumps — no τ move, no GT relabel. Details: [`DECIDE_V06_CUTOVER.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_V06_CUTOVER.md) · [`CATALOG_TWIN_EQUIVALENCE.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/CATALOG_TWIN_EQUIVALENCE.md) · [`V06_SHIP_RULE_SPEND.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/V06_SHIP_RULE_SPEND.md).

**What this is not.** Not a fresh held-out `productionTrusted` claim in the v0.4 sense. Optional frozen v0.6 is **confirmation only** (39/75 @ ≈83% LB, 2 above-τ search↔execute/hunt misses) — not a new live cite and not the docs.clawql.com number ([`DECIDE_V06_CONFIRMATION_CLOSEOUT.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_V06_CONFIRMATION_CLOSEOUT.md)).
...
| τ=0.80 provenance                       | **honest** — selected **after** miss known; **v0.4 spent for Decide reject** ([`DECIDE_TAU_080_PROVENANCE.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_TAU_080_PROVENANCE.md)) |
...
| Live path                               | **Decide** (T=0.75, τ=0.80) after twin-aware V06 spend — see [`DECIDE_V06_CUTOVER.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_V06_CUTOVER.md)                                 |
...
Closeout detail: [`DECIDE_V05_SCORE_ONCE_CLOSEOUT.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_V05_SCORE_ONCE_CLOSEOUT.md)
...
Details: [`V05_DECIDE_PRODUCTION_RULE_PREREGISTERED.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/V05_DECIDE_PRODUCTION_RULE_PREREGISTERED.md) · [`FREEZE-v0.5-routing-fresh.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/FREEZE-v0.5-routing-fresh.md)

## Related

- Spec: [`fast-decision-primitive-v0.4.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/specs/classifier/fast-decision-primitive-v0.4.md) §7
- Fit freeze: [`FIT_TAU_FREEZE_v0.1.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/FIT_TAU_FREEZE_v0.1.md)
- Eval log: [`ONTOLOGY_ENRICHMENT_EVAL_LOG.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/ONTOLOGY_ENRICHMENT_EVAL_LOG.md)
