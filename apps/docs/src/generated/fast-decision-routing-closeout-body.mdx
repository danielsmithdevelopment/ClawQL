...
Details: [`V05_DECIDE_PRODUCTION_RULE_PREREGISTERED.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/V05_DECIDE_PRODUCTION_RULE_PREREGISTERED.md) · [`DECIDE_V05_CANDIDATE_READOUT.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/packages/clawql-core/src/classifier/held-out/fixtures/DECIDE_V05_CANDIDATE_READOUT.md)
