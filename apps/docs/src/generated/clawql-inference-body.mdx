...
**Example policy + walkthrough:** [`docs/examples/inference/`](https://docs.clawql.com/examples/inference/) (`policy.yaml` + README).
...
Example manifest (full copy: [`docs/examples/inference/policy.yaml`](https://docs.clawql.com/examples/inference/policy.yaml)):
