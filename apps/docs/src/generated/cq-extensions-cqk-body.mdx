...
**Status:** Draft v0.1 · [ADR 0010](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/adr/0010-cq-file-extensions.md) · Base: [OKF v0.1](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md) · [memory/okf.md](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/okf.md)
...
Prefer the [decision rationale template](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/memory/okf-decision-rationale.md) body sections when `type: decision`. Worked example: [`docs/examples/ontology/okf/decision-rationale-template.md`](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/ontology/okf/decision-rationale-template.md).
