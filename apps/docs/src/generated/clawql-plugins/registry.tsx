...
export const pluginPages: PluginPageMeta[] = [
  {
    ...
    title: 'Gateway core',
    description:
      'Always-on ClawQL Core — search, execute, audit, cache, skills_list, and skills_get. Not optional plugins; composed in clawql-api on every install.',
    status: 'always-on',
    package: 'clawql-api',
    prev: null,
    next: 'panguard-proxy',
  ...
  },
  {
    ...
    title: 'Ouroboros',
    description:
      'Evolutionary loop MCP tools via clawql-harness — always registered. Optional Postgres lineage; Langfuse eval opt-in.',
    status: 'shipped',
