...
| `mcp-api-adapter`          | ✅ `0.4.0` — any MCP (stdio/HTTP/gRPC) → OpenAPI + GraphQL + gRPC ([guide](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/mcp/mcp-api-adapter.md), [design](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/design/mcp-api-adapter.md), [example](https://github.com/danielsmithdevelopment/ClawQL/blob/main/docs/examples/mcp-api-adapter/README.md)) |
