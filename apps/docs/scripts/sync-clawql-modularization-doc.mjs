 ...
 *
 * Run from apps/docs/: node scripts/sync-clawql-modularization-doc.mjs
 *
 * Docker (`COPY apps/docs/` into `/app`): repo `docs/` is not in the image.
 * We walk up from `apps/docs/` until `docs/vision/` is found; if never
...
/** Walk parents from `apps/docs/` until docs/vision exists in repo. */
...
body = body.replaceAll(
  '../../apps/docs/public/vision/clawql-dependency-stack.png',
