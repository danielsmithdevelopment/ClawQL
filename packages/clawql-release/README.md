...
Standalone binary: `clawql-release` (same commands without the `clawql` prefix).
...
See [`docs/security/golden-image-pipeline.md`](../../docs/security/golden-image-pipeline.md).
...
Full vision: [Immutable releases](https://docs.clawql.com/vision/immutable-releases) · [`docs/vision/clawql-hybrid-decentralized-github-alternative.md`](../../docs/vision/clawql-hybrid-decentralized-github-alternative.md)
