...
import { EXECUTOR_CMP_MEASUREMENTS, executorCmpDerivedStats } from "./executor-cmp-trace-demo.js";
...
describe("executorCmpDerivedStats", () => {
  it("matches executor-cmp-001.live.json headline math", () => {
    ...
    expect(m.clawql.toolDefsTokens + m.clawql.toolResultTokens).toBe(m.clawql.combinedInputTokens);
