...
Self-serve org dashboard (mounted with credits HATEOAS): `GET /credits/org?orgId=…&tenant=…` — plan/billing, API keys, usage, topology, traces. See [`docs/payments/customer-provisioning-core.md`](../../docs/payments/customer-provisioning-core.md).
